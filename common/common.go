...
const (
	...
	// EnvGitBuiltinConfigDisabled disables ArgoCD mandatory builtin git configuration options, false by default
	EnvGitBuiltinConfigDisabled = "ARGOCD_GIT_BUILTIN_CONFIG_DISABLED"
