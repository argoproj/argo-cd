...
//go:generate go run github.com/vektra/mockery/v2@v2.15.0 --srcpkg=github.com/microsoft/azure-devops-go-api/azuredevops/git --name=Client --output=azure_devops/git/mocks --outpkg=mocks
