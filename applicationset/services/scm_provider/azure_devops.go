...
func NewAzureDevOpsProvider(ctx context.Context, accessToken string, org string, url string, project string, allBranches bool, scmRootCAPath string, insecure bool) (*AzureDevOpsProvider, error) {
	if accessToken == "" {
	...
	tlsConfig := utils.GetTlsConfig(scmRootCAPath, insecure)
