		...
		case "/repositories/OWNER/REPO/pullrequests/":
			_, err = io.WriteString(w, `{
					...
					"values": [
						{
							"id": 101,
							"title": "A Bitbucket Cloud pull request",
							"source": {
								"branch": {
...
func TestListPullRequestBearerTokenCloud(t *testing.T) {
	...
	assert.Equal(t, "A Bitbucket Cloud pull request", pullRequests[0].Title)
		...
		case "/repositories/OWNER/REPO/pullrequests/?pagelen=1&page=2":
			_, err = io.WriteString(w, fmt.Sprintf(`{
				...
				"values": [
					{
						"id": 103,
                        "title": "PullRequest number fifty",
						"source": {
							"branch": {
								"name": "feature-103"
							},
		...
		case "/repositories/OWNER/REPO/pullrequests/":
			_, err = io.WriteString(w, fmt.Sprintf(`{
				...
				"values": [
					...
					{
						"id": 200,
                        "title": "PullRequest number onetyone",
						"source": {
							"branch": {
								"name": "feature-200"
							},
		...
		case "/repositories/OWNER/REPO/pullrequests/?pagelen=1&page=2":
			_, err = io.WriteString(w, fmt.Sprintf(`{
				...
				"values": [
					{
						"id": 102,
                        "title": "PullRequest number thwee",
						"source": {
							"branch": {
								"name": "feature-102"
							},
