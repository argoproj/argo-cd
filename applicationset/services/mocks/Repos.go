...
func (_mock *Repos) GetDirectories(ctx context.Context, repoURL string, revision string, project string, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity) ([]string, string, error) {
	...
	var r1 string
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, bool, *v1alpha1.SourceIntegrity) ([]string, string, error)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, string, bool, *v1alpha1.SourceIntegrity) string); ok {
		r1 = returnFunc(ctx, repoURL, revision, project, noRevisionCache, sourceIntegrity)
	} else {
		r1 = ret.Get(1).(string)
	}
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string, string, bool, *v1alpha1.SourceIntegrity) error); ok {
		r2 = returnFunc(ctx, repoURL, revision, project, noRevisionCache, sourceIntegrity)
	} else {
		r2 = ret.Error(2)
	}
	return r0, r1, r2
...
func (_c *Repos_GetDirectories_Call) RunAndReturn(run func(ctx context.Context, repoURL string, revision string, project string, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity) ([]string, string, error)) *Repos_GetDirectories_Call {
	_c.Call.Return(run)
	return _c
}

// GetFiles provides a mock function for the type Repos
func (_mock *Repos) GetFiles(ctx context.Context, repoURL string, revision string, project string, pattern string, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity) (map[string][]byte, string, error) {
	...
	var r1 string
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, string, bool, *v1alpha1.SourceIntegrity) (map[string][]byte, string, error)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, string, string, bool, *v1alpha1.SourceIntegrity) string); ok {
		r1 = returnFunc(ctx, repoURL, revision, project, pattern, noRevisionCache, sourceIntegrity)
	} else {
		r1 = ret.Get(1).(string)
	}
	if returnFunc, ok := ret.Get(2).(func(context.Context, string, string, string, string, bool, *v1alpha1.SourceIntegrity) error); ok {
		r2 = returnFunc(ctx, repoURL, revision, project, pattern, noRevisionCache, sourceIntegrity)
	} else {
		r2 = ret.Error(2)
	}
	return r0, r1, r2
...
func (_c *Repos_GetFiles_Call) RunAndReturn(run func(ctx context.Context, repoURL string, revision string, project string, pattern string, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity) (map[string][]byte, string, error)) *Repos_GetFiles_Call {
	_c.Call.Return(run)
	return _c
}
