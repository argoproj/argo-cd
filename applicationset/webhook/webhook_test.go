...
func TestWebhookHandler(t *testing.T) {
	tt := []struct {
		...
		},
		{
			...
			effectedAppSets:    []string{"github-shorthand"},
			expectedStatusCode: http.StatusOK,
			expectedRefresh:    true,
		},
		{
		...
		},
		{
			...
			effectedAppSets:    []string{"pull-request-github", "matrix-pull-request-github", "matrix-scm-pull-request-github", "merge-pull-request-github", "matrix-pull-request-github-plugin"},
			expectedStatusCode: http.StatusOK,
			expectedRefresh:    true,
		},
		{
		...
		},
		{
			...
			effectedAppSets:    []string{"git-azure-devops"},
			expectedStatusCode: http.StatusOK,
			expectedRefresh:    true,
		},
		{
			...
			effectedAppSets:    []string{"pull-request-azure-devops"},
			expectedStatusCode: http.StatusOK,
			expectedRefresh:    true,
		},
		{
			desc:               "WebHook with labels selector via a custom event event",
			headerKey:          "X-Custom-Event",
			headerValue:        "Not relevant",
			payloadFile:        "custom-event-with-labels-selector.json",
			effectedAppSets:    []string{"plugin"},
			expectedStatusCode: http.StatusOK,
			expectedRefresh:    true,
		},
	}
