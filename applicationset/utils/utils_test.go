		...
		t.Run(test.name, func(t *testing.T) {
			...
			for fieldName, getPtrFunc := range fieldMap {
				...
				*getPtrFunc(application) = test.fieldVal
				...
				// Render the cloned application, into a new application
				render := Render{}
				newApplication, err := render.RenderTemplateParams(application, nil, nil, test.params, false)
		...
		t.Run(test.name, func(t *testing.T) {
			...
			for fieldName, getPtrFunc := range fieldMap {
				...
				*getPtrFunc(application) = test.fieldVal
				...
				// Render the cloned application, into a new application
				render := Render{}
				newApplication, err := render.RenderTemplateParams(application, nil, nil, test.params, true)
...
func TestRenderTemplateKeys(t *testing.T) {
	t.Run("fasttemplate", func(t *testing.T) {
		...
		render := Render{}
		newApplication, err := render.RenderTemplateParams(application, nil, nil, params, false)
	...
	t.Run("gotemplate", func(t *testing.T) {
		...
		render := Render{}
		newApplication, err := render.RenderTemplateParams(application, nil, nil, params, true)
		require.NoError(t, err)
		require.Contains(t, newApplication.ObjectMeta.Annotations, "annotation-some-key")
		assert.Equal(t, newApplication.ObjectMeta.Annotations["annotation-some-key"], "annotation-some-value")
	})
...
func TestRenderTemplateParamsFinalizers(t *testing.T) {
	...
	for _, c := range []struct {
		...
		t.Run(c.testName, func(t *testing.T) {
			...
			res, err := render.RenderTemplateParams(application, nil, c.syncPolicy, params, true)
			assert.Nil(t, err)
