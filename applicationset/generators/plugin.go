...
func NewPluginGenerator(ctx context.Context, client client.Client, clientset kubernetes.Interface, namespace string, allowedPluginGenUrls []string) Generator {
	g := &PluginGenerator{
		client:               client,
		ctx:                  ctx,
		clientset:            clientset,
