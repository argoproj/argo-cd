...
`)
	type args struct {
		...
		verifyCommit      bool
		extraParamFiles   map[v1alpha1.ExtraParameterFileItem]interface{}
	}
	tests := []struct {
		name    string
		args    args
			...
			want: []map[string]interface{}{
				{
					...
					"extraParams": map[string]interface{}{
						"myExtraParams": map[string]interface{}{
							"firstKey": map[string]interface{}{
								"foo":  "barbarbar",
								"foo2": "bar2Override",
								"foo3": true,
...
`),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var extraParamFiles []argoprojiov1alpha1.ExtraParameterFileItem
			if len(tt.args.extraParamFiles) != 0 {
				keys := make([]argoprojiov1alpha1.ExtraParameterFileItem, 0, len(tt.args.extraParamFiles))
				...
				extraParamFiles = make([]argoprojiov1alpha1.ExtraParameterFileItem, 0)
