...
func GetGenerators(ctx context.Context, c client.Client, k8sClient kubernetes.Interface, namespace string, argoCDService services.Repos, dynamicClient dynamic.Interface, scmConfig SCMConfig, maxMatrixChildren int) map[string]Generator {
	...
	nestedGenerators := map[string]Generator{
		...
		"Matrix":                  NewMatrixGenerator(terminalGenerators, maxMatrixChildren),
	...
	topLevelGenerators := map[string]Generator{
		...
		"PullRequest":             terminalGenerators["PullRequest"],
		"Plugin":                  terminalGenerators["Plugin"],
		"Matrix":                  NewMatrixGenerator(nestedGenerators, maxMatrixChildren),
