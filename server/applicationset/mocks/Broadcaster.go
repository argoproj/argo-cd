...
func (_m *Broadcaster) Subscribe(ch chan *v1alpha1.ApplicationSetWatchEvent, filters ...func(*v1alpha1.ApplicationSetWatchEvent) bool) func() {
	...
	var r0 func()
	if rf, ok := ret.Get(0).(func(chan *v1alpha1.ApplicationSetWatchEvent, ...func(*v1alpha1.ApplicationSetWatchEvent) bool) func()); ok {
		r0 = rf(ch, filters...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(func())
