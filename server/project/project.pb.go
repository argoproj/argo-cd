...
type ProjectTokenCreateRequest struct {
	...
	SecondsBeforeExpiry int32                                                                   `protobuf:"varint,3,opt,name=secondsBeforeExpiry,proto3" json:"secondsBeforeExpiry,omitempty"`
}
...
func (m *ProjectTokenCreateRequest) GetSecondsBeforeExpiry() int32 {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SecondsBeforeExpiry |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProject = []byte{
	...
	,
}
