...
func (s *Server) CreateToken(ctx context.Context, q *ProjectTokenCreateRequest) (*ProjectTokenResponse, error) {
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionUpdate, q.Project) {
...
func (s *Server) DeleteToken(ctx context.Context, q *ProjectTokenDeleteRequest) (*EmptyResponse, error) {
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionDelete, q.Project) {
		return nil, grpc.ErrPermissionDenied
	}
	project, err := s.appclientset.ArgoprojV1alpha1().AppProjects(s.ns).Get(q.Project, metav1.GetOptions{})
	if err != nil {
...
func (s *Server) Create(ctx context.Context, q *ProjectCreateRequest) (*v1alpha1.AppProject, error) {
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, "create", q.Project.Name) {
		return nil, grpc.ErrPermissionDenied
	}
...
func (s *Server) List(ctx context.Context, q *ProjectQuery) (*v1alpha1.AppProjectList, error) {
	...
	if list != nil {
		...
		for i := range list.Items {
			...
			if s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionGet, project.Name) {
...
func (s *Server) Get(ctx context.Context, q *ProjectQuery) (*v1alpha1.AppProject, error) {
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionGet, q.Name) {
		return nil, grpc.ErrPermissionDenied
	}
...
func (s *Server) Update(ctx context.Context, q *ProjectUpdateRequest) (*v1alpha1.AppProject, error) {
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionUpdate, q.Project.Name) {
		return nil, grpc.ErrPermissionDenied
	}
	err := validateProject(q.Project)
	if err != nil {
...
func (s *Server) Delete(ctx context.Context, q *ProjectQuery) (*EmptyResponse, error) {
	...
	if !s.enf.EnforceClaims(ctx.Value(common.ClaimsSubjectKey), common.ClaimsObjectProjects, common.ClaimsActionDelete, q.Name) {
		return nil, grpc.ErrPermissionDenied
	}
