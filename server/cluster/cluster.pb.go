...
func (*ClusterQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_79097064e119a5a6, []int{0}
}
...
func (*ClusterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_79097064e119a5a6, []int{1}
}
...
func (*ClusterCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_79097064e119a5a6, []int{2}
}
...
func (*ClusterCreateFromKubeConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_79097064e119a5a6, []int{3}
}
...
func (*ClusterUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_79097064e119a5a6, []int{4}
}
...
func init() {
	proto.RegisterFile("server/cluster/cluster.proto", fileDescriptor_cluster_79097064e119a5a6)
}

var fileDescriptor_cluster_79097064e119a5a6 = []byte{
