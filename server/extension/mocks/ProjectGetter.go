...
// GetClusters provides a mock function with given fields: ctx, project
func (_m *ProjectGetter) GetClusters(ctx context.Context, project string) ([]*v1alpha1.Cluster, error) {
