...
func newEnv(q *apiclient.ManifestRequest, revision, kubeVersion string, repos []*v1alpha1.Repository) *v1alpha1.Env {
	return &v1alpha1.Env{
		...
		&v1alpha1.EnvEntry{Name: "ARGOCD_REPOS", Value: fmt.Sprintf("%v", repos)},
	}
}
