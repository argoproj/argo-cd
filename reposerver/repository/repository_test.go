...
var LsSignaturesMockOk = func(revision string, _ bool) (info []git.RevisionSignatureInfo, err error) {
	return []git.RevisionSignatureInfo{
		{
			"d71589b8001a0bd78bb311cb03c9d129c6f91de1",
			git.GPGVerificationResultGood,
			"GOOD",
			"Fri Oct 31 14:42:39 2025 +0100",
			"Jane Doe <jdoe@acme.com>",
		},
	}, nil
}

var sourceIntegrityResultOK = &v1alpha1.SourceIntegrityCheckResult{Checks: []v1alpha1.SourceIntegrityCheckResultItem{{
	Name:     "Fake/Check",
	Problems: []string{},
}}}
var LsSignaturesMockGitError = func(revision string, _ bool) (info []git.RevisionSignatureInfo, err error) {
	return []git.RevisionSignatureInfo{{
		"171589b8001a0bd78bb311cb03c9d129c6f91de1",
		git.GPGVerificationResultExpiredKey,
		"EXPIRED",
		"Fri Oct 31 14:42:39 2025 +0100",
		"Late Fred <lfred@acme.com>",
	}, {
		"111589b8001a0bd78bb311cb03c9d129c6f91de1",
		git.GPGVerificationResultUnsigned,
		"",
		"Fri Oct 31 14:42:39 2025 +0100",
		"Unsigned <unsigned@acme.com>",
	}}, nil
}
...
func TestGetSignatureVerificationResult(t *testing.T) {
	// Commit with signature and verification requested
	{
		...
		require.NoError(t, err)
		assert.True(t, res.SourceIntegrityResult.IsValid())
		assert.NoError(t, res.SourceIntegrityResult.Error())
	}
	...
	// Commit without signature and verification requested
	{
		...
		assert.Error(t, res.SourceIntegrityResult.Error())
	}
