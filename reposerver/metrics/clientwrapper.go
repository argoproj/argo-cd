...
func wrapGitClient(repo string, metricsServer *MetricsServer, client depot.Client) depot.Client {
...
func (w *clientWrapper) RevisionMetadata(path, revision string) (*depot.RevisionMetadata, error) {
