...
// CheckChangesForPaths provides a mock function for the type RepoServerServiceClient
func (_mock *RepoServerServiceClient) CheckChangesForPaths(ctx context.Context, in *apiclient.CheckChangesForPathsRequest, opts ...grpc.CallOption) (*apiclient.CheckChangesForPathsResponse, error) {
	// grpc.CallOption
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckChangesForPaths")
	}

	var r0 *apiclient.CheckChangesForPathsResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *apiclient.CheckChangesForPathsRequest, ...grpc.CallOption) (*apiclient.CheckChangesForPathsResponse, error)); ok {
		return returnFunc(ctx, in, opts...)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *apiclient.CheckChangesForPathsRequest, ...grpc.CallOption) *apiclient.CheckChangesForPathsResponse); ok {
		r0 = returnFunc(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*apiclient.CheckChangesForPathsResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, *apiclient.CheckChangesForPathsRequest, ...grpc.CallOption) error); ok {
...
// CheckChangesForPaths is a helper method to define mock.On call
//   - ctx context.Context
//   - in *apiclient.CheckChangesForPathsRequest
//   - opts ...grpc.CallOption
func (_e *RepoServerServiceClient_Expecter) CheckChangesForPaths(ctx interface{}, in interface{}, opts ...interface{}) *RepoServerServiceClient_CheckChangesForPaths_Call {
	return &RepoServerServiceClient_CheckChangesForPaths_Call{Call: _e.mock.On("CheckChangesForPaths",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *RepoServerServiceClient_CheckChangesForPaths_Call) Run(run func(ctx context.Context, in *apiclient.CheckChangesForPathsRequest, opts ...grpc.CallOption)) *RepoServerServiceClient_CheckChangesForPaths_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *apiclient.CheckChangesForPathsRequest
		if args[1] != nil {
			arg1 = args[1].(*apiclient.CheckChangesForPathsRequest)
		}
...
func (_c *RepoServerServiceClient_CheckChangesForPaths_Call) Return(checkChangesForPathsResponse *apiclient.CheckChangesForPathsResponse, err error) *RepoServerServiceClient_CheckChangesForPaths_Call {
	_c.Call.Return(checkChangesForPathsResponse, err)
	return _c
}

func (_c *RepoServerServiceClient_CheckChangesForPaths_Call) RunAndReturn(run func(ctx context.Context, in *apiclient.CheckChangesForPathsRequest, opts ...grpc.CallOption) (*apiclient.CheckChangesForPathsResponse, error)) *RepoServerServiceClient_CheckChangesForPaths_Call {
	_c.Call.Return(run)
	return _c
}
