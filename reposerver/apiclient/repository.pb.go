...
type ManifestRequest struct {
	...
	// resolution contains the intermediate revision resolution when a semver constraint was resolved
	Resolution           *RevisionResolution `protobuf:"bytes,28,opt,name=resolution,proto3" json:"resolution,omitempty"`
...
func (m *ManifestRequest) GetResolution() *RevisionResolution {
	if m != nil {
		return m.Resolution
	}
	return nil
...
// (e.g. semver range "v1.*") to a concrete tag (e.g. "v1.2.3") before final SHA/digest resolution.
// Only populated when a semver constraint was actually resolved; empty for exact tags and SHAs.
...
func (m *RevisionResolution) Reset()         { *m = RevisionResolution{} }
func (m *RevisionResolution) String() string { return proto.CompactTextString(m) }
func (*RevisionResolution) ProtoMessage()    {}
func (*RevisionResolution) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{7}
}
func (m *RevisionResolution) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RevisionResolution) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RevisionResolution.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RevisionResolution) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevisionResolution.Merge(m, src)
}
func (m *RevisionResolution) XXX_Size() int {
	return m.Size()
}
func (m *RevisionResolution) XXX_DiscardUnknown() {
	xxx_messageInfo_RevisionResolution.DiscardUnknown(m)
}

var xxx_messageInfo_RevisionResolution proto.InternalMessageInfo

func (m *RevisionResolution) GetResolvedSymbol() string {
	if m != nil {
...
type ResolveRevisionResponse struct {
	...
	// resolution contains the intermediate revision resolution when a semver constraint was resolved
	Resolution           *RevisionResolution `protobuf:"bytes,3,opt,name=resolution,proto3" json:"resolution,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ResolveRevisionResponse) GetResolution() *RevisionResolution {
	if m != nil {
		return m.Resolution
	}
	return nil
...
type ManifestResponse struct {
	...
	// resolution contains the intermediate revision resolution when a semver constraint was resolved
	Resolution           *RevisionResolution `protobuf:"bytes,9,opt,name=resolution,proto3" json:"resolution,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ManifestResponse) GetResolution() *RevisionResolution {
	if m != nil {
		return m.Resolution
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RevisionResolution)(nil), "repository.RevisionResolution")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *RevisionResolution) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RevisionResolution) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RevisionResolution) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Constraint) > 0 {
		...
		i = encodeVarintRepository(dAtA, i, uint64(len(m.Constraint)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ResolvedSymbol) > 0 {
		i -= len(m.ResolvedSymbol)
		copy(dAtA[i:], m.ResolvedSymbol)
		i = encodeVarintRepository(dAtA, i, uint64(len(m.ResolvedSymbol)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RevisionResolution) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.ResolvedSymbol)
	if l > 0 {
		n += 1 + l + sovRepository(uint64(l))
	}
	l = len(m.Constraint)
...
func (m *ManifestRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			if m.Resolution == nil {
				m.Resolution = &RevisionResolution{}
			}
...
func (m *RevisionResolution) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevisionResolution: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevisionResolution: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResolvedSymbol", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ResolvedSymbol = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
