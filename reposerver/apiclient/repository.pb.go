...
type TestRepositoryRequest struct {
	Repo                 *v1alpha1.Repository `protobuf:"bytes,1,opt,name=repo,proto3" json:"repo,omitempty"`
	IsHelm               bool                 `protobuf:"varint,2,opt,name=isHelm,proto3" json:"isHelm,omitempty"`
	IsHelmOci            bool                 `protobuf:"varint,3,opt,name=isHelmOci,proto3" json:"isHelmOci,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *TestRepositoryRequest) GetIsHelm() bool {
	if m != nil {
		return m.IsHelm
	}
	return false
...
func (m *TestRepositoryRequest) GetIsHelmOci() bool {
	if m != nil {
		return m.IsHelmOci
	}
	return false
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *TestRepositoryRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsHelm", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsHelmOci", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
