...
type ListAppsRequest struct {
	...
	SparseCheckoutPaths  []string             `protobuf:"bytes,4,rep,name=sparseCheckoutPaths,proto3" json:"sparseCheckoutPaths,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *ListAppsRequest) GetSparseCheckoutPaths() []string {
	if m != nil {
		return m.SparseCheckoutPaths
	}
	return nil
}
...
type GitFilesRequest struct {
	...
	SparseCheckoutPaths       []string             `protobuf:"bytes,8,rep,name=sparseCheckoutPaths,proto3" json:"sparseCheckoutPaths,omitempty"`
	XXX_NoUnkeyedLiteral      struct{}             `json:"-"`
	XXX_unrecognized          []byte               `json:"-"`
	XXX_sizecache             int32                `json:"-"`
}
...
func (m *GitFilesRequest) GetSparseCheckoutPaths() []string {
	if m != nil {
		return m.SparseCheckoutPaths
	}
	return nil
...
type GitDirectoriesRequest struct {
	...
	SparseCheckoutPaths  []string             `protobuf:"bytes,6,rep,name=sparseCheckoutPaths,proto3" json:"sparseCheckoutPaths,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *GitDirectoriesRequest) GetSparseCheckoutPaths() []string {
	if m != nil {
		return m.SparseCheckoutPaths
	}
	return nil
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *ListAppsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SparseCheckoutPaths) > 0 {
		for iNdEx := len(m.SparseCheckoutPaths) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SparseCheckoutPaths[iNdEx])
			copy(dAtA[i:], m.SparseCheckoutPaths[iNdEx])
			i = encodeVarintRepository(dAtA, i, uint64(len(m.SparseCheckoutPaths[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *ListAppsRequest) Size() (n int) {
	...
	if len(m.SparseCheckoutPaths) > 0 {
		for _, s := range m.SparseCheckoutPaths {
			l = len(s)
			n += 1 + l + sovRepository(uint64(l))
		}
	}
...
func (m *ListAppsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SparseCheckoutPaths", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SparseCheckoutPaths = append(m.SparseCheckoutPaths, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
