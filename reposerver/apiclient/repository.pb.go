...
type ManifestRequest struct {
	...
	VerifySignature      bool                  `protobuf:"varint,17,opt,name=verifySignature,proto3" json:"verifySignature,omitempty"`
	HelmRepoCreds        []*v1alpha1.RepoCreds `protobuf:"bytes,18,rep,name=helmRepoCreds,proto3" json:"helmRepoCreds,omitempty"`
	NoRevisionCache      bool                  `protobuf:"varint,19,opt,name=noRevisionCache,proto3" json:"noRevisionCache,omitempty"`
