...
type ManifestRequest struct {
	...
	// used for looking up generated values from other charts
	ValueRefManifests map[string]string `protobuf:"bytes,26,rep,name=valueRefManifests,proto3" json:"valueRefManifests,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// tell the repo-server that we are generating a values file, not kubernetes manifests
	IsMultistageSource   bool     `protobuf:"varint,27,opt,name=isMultistageSource,proto3" json:"isMultistageSource,omitempty"`
...
func (m *ManifestRequest) GetValueRefManifests() map[string]string {
	if m != nil {
		return m.ValueRefManifests
	}
	return nil
}

func (m *ManifestRequest) GetIsMultistageSource() bool {
	if m != nil {
		return m.IsMultistageSource
	}
	return false
}
...
type ManifestCacheRef struct {
	...
	RefSources           []*v1alpha1.RefTarget       `protobuf:"bytes,3,rep,name=refSources,proto3" json:"refSources,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *ManifestCacheRef) Reset()         { *m = ManifestCacheRef{} }
func (m *ManifestCacheRef) String() string { return proto.CompactTextString(m) }
func (*ManifestCacheRef) ProtoMessage()    {}
func (*ManifestCacheRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{2}
}
func (m *ManifestCacheRef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ManifestCacheRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ManifestCacheRef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ManifestCacheRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ManifestCacheRef.Merge(m, src)
}
func (m *ManifestCacheRef) XXX_Size() int {
	return m.Size()
}
func (m *ManifestCacheRef) XXX_DiscardUnknown() {
	xxx_messageInfo_ManifestCacheRef.DiscardUnknown(m)
}

var xxx_messageInfo_ManifestCacheRef proto.InternalMessageInfo

func (m *ManifestCacheRef) GetCacheKey() string {
	if m != nil {
		return m.CacheKey
	}
	return ""
...
func (m *ManifestCacheRef) GetSource() *v1alpha1.ApplicationSource {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *ManifestCacheRef) GetRefSources() []*v1alpha1.RefTarget {
	if m != nil {
		return m.RefSources
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "repository.ManifestRequest.ValueRefManifestsEntry")
	proto.RegisterType((*ManifestRequestWithFiles)(nil), "repository.ManifestRequestWithFiles")
	proto.RegisterType((*ManifestCacheRef)(nil), "repository.ManifestCacheRef")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *ManifestRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValueRefManifests) > 0 {
		for k := range m.ValueRefManifests {
			v := m.ValueRefManifests[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *ManifestCacheRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ManifestCacheRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ManifestCacheRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.RefSources) > 0 {
		for iNdEx := len(m.RefSources) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RefSources[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.CacheKey) > 0 {
		...
		i = encodeVarintRepository(dAtA, i, uint64(len(m.CacheKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ManifestRequest) Size() (n int) {
	...
	if len(m.ValueRefManifests) > 0 {
		for k, v := range m.ValueRefManifests {
			_ = k
			_ = v
...
func (m *ManifestCacheRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ManifestRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValueRefManifests", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ValueRefManifests == nil {
				m.ValueRefManifests = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.ValueRefManifests[mapkey] = mapvalue
			iNdEx = postIndex
		case 27:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsMultistageSource", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ManifestCacheRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ManifestCacheRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ManifestCacheRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.RefSources = append(m.RefSources, &v1alpha1.RefTarget{})
			if err := m.RefSources[len(m.RefSources)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
