...
type ManifestResponse struct {
	...
	// HelmLookupWarnings reports template files that invoke the unsupported Helm `lookup` function.
	HelmLookupWarnings   []string `protobuf:"bytes,9,rep,name=helmLookupWarnings,proto3" json:"helmLookupWarnings,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ManifestResponse) GetHelmLookupWarnings() []string {
	if m != nil {
		return m.HelmLookupWarnings
	}
	return nil
}
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *ManifestResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HelmLookupWarnings) > 0 {
		for iNdEx := len(m.HelmLookupWarnings) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.HelmLookupWarnings[iNdEx])
			copy(dAtA[i:], m.HelmLookupWarnings[iNdEx])
			i = encodeVarintRepository(dAtA, i, uint64(len(m.HelmLookupWarnings[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (m *ManifestResponse) Size() (n int) {
	...
	if len(m.HelmLookupWarnings) > 0 {
		for _, s := range m.HelmLookupWarnings {
			l = len(s)
			n += 1 + l + sovRepository(uint64(l))
		}
	}
...
func (m *ManifestResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HelmLookupWarnings", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HelmLookupWarnings = append(m.HelmLookupWarnings, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
