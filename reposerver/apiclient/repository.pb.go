...
type UpdateRevisionForPathsRequest struct {
	...
	CacheRepoRefs        map[string]string              `protobuf:"bytes,16,rep,name=cacheRepoRefs,proto3" json:"cacheRepoRefs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
func (m *UpdateRevisionForPathsRequest) GetCacheRepoRefs() map[string]string {
	if m != nil {
		return m.CacheRepoRefs
	}
	return nil
}
...
type CheckChangesForPathsRequest struct {
	Repo                 *v1alpha1.Repository `protobuf:"bytes,1,opt,name=repo,proto3" json:"repo,omitempty"`
	Revision             string               `protobuf:"bytes,2,opt,name=revision,proto3" json:"revision,omitempty"`
...
func (m *CheckChangesForPathsRequest) Reset()         { *m = CheckChangesForPathsRequest{} }
func (m *CheckChangesForPathsRequest) String() string { return proto.CompactTextString(m) }
func (*CheckChangesForPathsRequest) ProtoMessage()    {}
func (*CheckChangesForPathsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{33}
}
func (m *CheckChangesForPathsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckChangesForPathsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckChangesForPathsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckChangesForPathsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckChangesForPathsRequest.Merge(m, src)
}
func (m *CheckChangesForPathsRequest) XXX_Size() int {
	return m.Size()
}
func (m *CheckChangesForPathsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckChangesForPathsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CheckChangesForPathsRequest proto.InternalMessageInfo

func (m *CheckChangesForPathsRequest) GetRepo() *v1alpha1.Repository {
	if m != nil {
		return m.Repo
	}
	return nil
...
func (m *CheckChangesForPathsRequest) GetRevision() string {
	if m != nil {
		return m.Revision
	}
	return ""
...
func (m *CheckChangesForPathsRequest) GetSyncedRevision() string {
	if m != nil {
		return m.SyncedRevision
	}
	return ""
...
func (m *CheckChangesForPathsRequest) GetPaths() []string {
	if m != nil {
		return m.Paths
	}
	return nil
...
func (m *CheckChangesForPathsRequest) GetNoRevisionCache() bool {
	if m != nil {
		return m.NoRevisionCache
	}
	return false
...
type CheckChangesForPathsResponse struct {
	// Changes indicates whether any changes were detected in the provided paths. If false, it means that the source
	// has changes. If true, it means that there are relevant changes in the repo files and
	// that new manifests should be generated.
	Changes              bool     `protobuf:"varint,1,opt,name=changes,proto3" json:"changes,omitempty"`
	Revision             string   `protobuf:"bytes,2,opt,name=revision,proto3" json:"revision,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
...
func (m *CheckChangesForPathsResponse) Reset()         { *m = CheckChangesForPathsResponse{} }
func (m *CheckChangesForPathsResponse) String() string { return proto.CompactTextString(m) }
func (*CheckChangesForPathsResponse) ProtoMessage()    {}
func (*CheckChangesForPathsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{34}
}
func (m *CheckChangesForPathsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckChangesForPathsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckChangesForPathsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckChangesForPathsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckChangesForPathsResponse.Merge(m, src)
}
func (m *CheckChangesForPathsResponse) XXX_Size() int {
	return m.Size()
}
func (m *CheckChangesForPathsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckChangesForPathsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CheckChangesForPathsResponse proto.InternalMessageInfo

func (m *CheckChangesForPathsResponse) GetChanges() bool {
	if m != nil {
		return m.Changes
	}
	return false
...
func (m *CheckChangesForPathsResponse) GetRevision() string {
	if m != nil {
		return m.Revision
	}
	return ""
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "repository.UpdateRevisionForPathsRequest.CacheRepoRefsEntry")
	...
	proto.RegisterType((*CheckChangesForPathsRequest)(nil), "repository.CheckChangesForPathsRequest")
	proto.RegisterType((*CheckChangesForPathsResponse)(nil), "repository.CheckChangesForPathsResponse")
}
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
type RepoServerServiceClient interface {
	...
	// CheckChangesForPaths will compare 2 revision for git repo and get the result
	CheckChangesForPaths(ctx context.Context, in *CheckChangesForPathsRequest, opts ...grpc.CallOption) (*CheckChangesForPathsResponse, error)
}
...
func (c *repoServerServiceClient) CheckChangesForPaths(ctx context.Context, in *CheckChangesForPathsRequest, opts ...grpc.CallOption) (*CheckChangesForPathsResponse, error) {
	out := new(CheckChangesForPathsResponse)
	err := c.cc.Invoke(ctx, "/repository.RepoServerService/CheckChangesForPaths", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepoServerServiceServer interface {
	...
	// CheckChangesForPaths will compare 2 revision for git repo and get the result
	CheckChangesForPaths(context.Context, *CheckChangesForPathsRequest) (*CheckChangesForPathsResponse, error)
}
...
func (*UnimplementedRepoServerServiceServer) CheckChangesForPaths(ctx context.Context, req *CheckChangesForPathsRequest) (*CheckChangesForPathsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckChangesForPaths not implemented")
}
...
func _RepoServerService_CheckChangesForPaths_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckChangesForPathsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepoServerServiceServer).CheckChangesForPaths(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepoServerService/CheckChangesForPaths",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepoServerServiceServer).CheckChangesForPaths(ctx, req.(*CheckChangesForPathsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RepoServerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckChangesForPaths",
			Handler:    _RepoServerService_CheckChangesForPaths_Handler,
		},
	},
...
func (m *UpdateRevisionForPathsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CacheRepoRefs) > 0 {
		for k := range m.CacheRepoRefs {
			v := m.CacheRepoRefs[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *CheckChangesForPathsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckChangesForPathsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckChangesForPathsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CheckChangesForPathsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckChangesForPathsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckChangesForPathsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CheckChangesForPathsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CheckChangesForPathsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateRevisionForPathsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheRepoRefs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CacheRepoRefs == nil {
				m.CacheRepoRefs = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.CacheRepoRefs[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
...
func (m *CheckChangesForPathsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckChangesForPathsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckChangesForPathsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CheckChangesForPathsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckChangesForPathsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckChangesForPathsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
