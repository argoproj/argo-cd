...
type UpdateRevisionForPathsRequest struct {
	...
	// lastSyncedRevision is the revision of the most recent sync attempt. When set, `changes` is computed against it
	// instead of syncedRevision, answering "changed since the last sync?" rather than "since the last comparison?".
	// syncedRevision stays the base for the manifest cache transfer. When empty, it is the base for both (legacy).
	LastSyncedRevision string `protobuf:"bytes,17,opt,name=lastSyncedRevision,proto3" json:"lastSyncedRevision,omitempty"`
	// lastSyncedRefSources are the ref sources resolved at the revisions of the most recent sync attempt. Only
	// consulted when lastSyncedRevision is set.
	LastSyncedRefSources map[string]*v1alpha1.RefTarget `protobuf:"bytes,18,rep,name=lastSyncedRefSources,proto3" json:"lastSyncedRefSources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
func (m *UpdateRevisionForPathsRequest) GetLastSyncedRevision() string {
	if m != nil {
		return m.LastSyncedRevision
	}
	return ""
}

func (m *UpdateRevisionForPathsRequest) GetLastSyncedRefSources() map[string]*v1alpha1.RefTarget {
	if m != nil {
		return m.LastSyncedRefSources
	}
	return nil
}

type UpdateRevisionForPathsResponse struct {
	// Changes indicates whether any changes were detected in the provided paths since the base revision (the request's
	// lastSyncedRevision when set, otherwise its syncedRevision). If false and the revision advanced from
	// syncedRevision, the manifest cache was updated to the new revision. If true, it means that there are relevant
	// changes in the repo files and that new manifests should be generated.
...
func init() {
	...
	proto.RegisterMapType((map[string]*v1alpha1.RefTarget)(nil), "repository.UpdateRevisionForPathsRequest.LastSyncedRefSourcesEntry")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *UpdateRevisionForPathsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LastSyncedRefSources) > 0 {
		for k := range m.LastSyncedRefSources {
			v := m.LastSyncedRefSources[k]
			baseI := i
			if v != nil {
				{
					size, err := v.MarshalToSizedBuffer(dAtA[:i])
	...
	if len(m.LastSyncedRevision) > 0 {
		i -= len(m.LastSyncedRevision)
		copy(dAtA[i:], m.LastSyncedRevision)
		i = encodeVarintRepository(dAtA, i, uint64(len(m.LastSyncedRevision)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
...
func (m *UpdateRevisionForPathsRequest) Size() (n int) {
	...
	l = len(m.LastSyncedRevision)
	if l > 0 {
		n += 2 + l + sovRepository(uint64(l))
	}
	if len(m.LastSyncedRefSources) > 0 {
		for k, v := range m.LastSyncedRefSources {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *UpdateRevisionForPathsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastSyncedRevision", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LastSyncedRevision = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastSyncedRefSources", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LastSyncedRefSources == nil {
				m.LastSyncedRefSources = make(map[string]*v1alpha1.RefTarget)
			}
			var mapkey string
			var mapvalue *v1alpha1.RefTarget
			for iNdEx < postIndex {
			...
			m.LastSyncedRefSources[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
