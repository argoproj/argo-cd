...
type ManifestRequest struct {
	...
	EnableManifestGenerationForSourceType map[string]bool       `protobuf:"bytes,20,rep,name=enableManifestGenerationForSourceType,proto3" json:"enableManifestGenerationForSourceType,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (m *ManifestRequest) GetEnableManifestGenerationForSourceType() map[string]bool {
	if m != nil {
		return m.EnableManifestGenerationForSourceType
	}
	return nil
}
...
type ListAppsRequest struct {
	Repo                                  *v1alpha1.Repository `protobuf:"bytes,1,opt,name=repo,proto3" json:"repo,omitempty"`
	Revision                              string               `protobuf:"bytes,2,opt,name=revision,proto3" json:"revision,omitempty"`
	EnableManifestGenerationForSourceType map[string]bool      `protobuf:"bytes,3,rep,name=enableManifestGenerationForSourceType,proto3" json:"enableManifestGenerationForSourceType,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral                  struct{}             `json:"-"`
	XXX_unrecognized                      []byte               `json:"-"`
	XXX_sizecache                         int32                `json:"-"`
}
...
func (m *ListAppsRequest) GetEnableManifestGenerationForSourceType() map[string]bool {
	if m != nil {
		return m.EnableManifestGenerationForSourceType
	}
	return nil
...
type RepoServerAppDetailsQuery struct {
	...
	EnableManifestGenerationForSourceType map[string]bool             `protobuf:"bytes,9,rep,name=enableManifestGenerationForSourceType,proto3" json:"enableManifestGenerationForSourceType,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral                  struct{}                    `json:"-"`
	XXX_unrecognized                      []byte                      `json:"-"`
	XXX_sizecache                         int32                       `json:"-"`
}
...
func (m *RepoServerAppDetailsQuery) GetEnableManifestGenerationForSourceType() map[string]bool {
	if m != nil {
		return m.EnableManifestGenerationForSourceType
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]bool)(nil), "repository.ManifestRequest.EnableManifestGenerationForSourceTypeEntry")
	...
	proto.RegisterMapType((map[string]bool)(nil), "repository.ListAppsRequest.EnableManifestGenerationForSourceTypeEntry")
	...
	proto.RegisterMapType((map[string]bool)(nil), "repository.RepoServerAppDetailsQuery.EnableManifestGenerationForSourceTypeEntry")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *ManifestRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EnableManifestGenerationForSourceType) > 0 {
		for k := range m.EnableManifestGenerationForSourceType {
			v := m.EnableManifestGenerationForSourceType[k]
			baseI := i
			i--
			if v {
				dAtA[i] = 1
...
func (m *ManifestRequest) Size() (n int) {
	...
	if len(m.EnableManifestGenerationForSourceType) > 0 {
		for k, v := range m.EnableManifestGenerationForSourceType {
			_ = k
			_ = v
...
func (m *ManifestRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableManifestGenerationForSourceType", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EnableManifestGenerationForSourceType == nil {
				m.EnableManifestGenerationForSourceType = make(map[string]bool)
			}
			var mapkey string
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.EnableManifestGenerationForSourceType[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
