...
func (m *SourceMeta) Reset()         { *m = SourceMeta{} }
func (m *SourceMeta) String() string { return proto.CompactTextString(m) }
func (*SourceMeta) ProtoMessage()    {}
func (*SourceMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd8723cfcc820480, []int{31}
}
func (m *SourceMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SourceMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SourceMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SourceMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SourceMeta.Merge(m, src)
}
func (m *SourceMeta) XXX_Size() int {
	return m.Size()
}
func (m *SourceMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_SourceMeta.DiscardUnknown(m)
}

var xxx_messageInfo_SourceMeta proto.InternalMessageInfo

func (m *SourceMeta) GetRepo() *v1alpha1.Repository {
	if m != nil {
		return m.Repo
	}
	return nil
...
func (m *SourceMeta) GetRevision() string {
	if m != nil {
		return m.Revision
	}
	return ""
...
func (m *SourceMeta) GetSyncedRevision() string {
	if m != nil {
...
type UpdateRevisionForPathsRequest struct {
	AppLabelKey        string                         `protobuf:"bytes,1,opt,name=appLabelKey,proto3" json:"appLabelKey,omitempty"`
	AppName            string                         `protobuf:"bytes,2,opt,name=appName,proto3" json:"appName,omitempty"`
	Namespace          string                         `protobuf:"bytes,3,opt,name=namespace,proto3" json:"namespace,omitempty"`
	ApplicationSource  *v1alpha1.ApplicationSource    `protobuf:"bytes,4,opt,name=applicationSource,proto3" json:"applicationSource,omitempty"`
	TrackingMethod     string                         `protobuf:"bytes,5,opt,name=trackingMethod,proto3" json:"trackingMethod,omitempty"`
	RefSources         map[string]*v1alpha1.RefTarget `protobuf:"bytes,6,rep,name=refSources,proto3" json:"refSources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	KubeVersion        string                         `protobuf:"bytes,7,opt,name=kubeVersion,proto3" json:"kubeVersion,omitempty"`
	ApiVersions        []string                       `protobuf:"bytes,8,rep,name=apiVersions,proto3" json:"apiVersions,omitempty"`
	HasMultipleSources bool                           `protobuf:"varint,9,opt,name=hasMultipleSources,proto3" json:"hasMultipleSources,omitempty"`
	...
	NoRevisionCache    bool                           `protobuf:"varint,13,opt,name=noRevisionCache,proto3" json:"noRevisionCache,omitempty"`
	InstallationID     string                         `protobuf:"bytes,14,opt,name=installationID,proto3" json:"installationID,omitempty"`
	// SourceMetas contains metadata for all sources to check (main source and ref sources)
	// Each SourceMeta contains repository with credentials, revision, and syncedRevision
	SourceMetas          []*SourceMeta `protobuf:"bytes,15,rep,name=sourceMetas,proto3" json:"sourceMetas,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *UpdateRevisionForPathsRequest) GetSourceMetas() []*SourceMeta {
	if m != nil {
		return m.SourceMetas
	}
	return nil
}
...
type UpdateRevisionForPathsResponse struct {
	...
	Revision string `protobuf:"bytes,2,opt,name=revision,proto3" json:"revision,omitempty"`
	// Changes indicates whether any changes were detected in the provided paths between syncedRevision and revision.
	// If true, it means that there are relevant changes in the repo files and that new manifests should be generated.
	// If false, it means no changes were detected and the cache was updated.
	Changes              bool     `protobuf:"varint,3,opt,name=changes,proto3" json:"changes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterType((*SourceMeta)(nil), "repository.SourceMeta")
...
var fileDescriptor_dd8723cfcc820480 = []byte{
	...
	,
}
...
func (m *SourceMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SourceMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SourceMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateRevisionForPathsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SourceMetas) > 0 {
		for iNdEx := len(m.SourceMetas) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SourceMetas[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SourceMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SourceMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SourceMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateRevisionForPathsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceMetas", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SourceMetas = append(m.SourceMetas, &SourceMeta{})
			if err := m.SourceMetas[len(m.SourceMetas)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
