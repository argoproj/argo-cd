...
require (
	...
	github.com/asaf-erlich/gitops-engine v0.7.4-aerlich // indirect
...
replace (
	// TODO remove once https://github.com/argoproj/gitops-engine/pull/565 is merged
	github.com/argoproj/gitops-engine => github.com/asaf-erlich/gitops-engine v0.7.4-aerlich
