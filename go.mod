...
replace (
	// TODO: remove this after merging https://github.com/argoproj/gitops-engine/pull/732
	github.com/argoproj/gitops-engine => github.com/crenshaw-dev/gitops-engine v0.6.1-0.20250606031248-b33a03c33000
