...
require (
	...
	github.com/argoproj/gitops-engine v0.7.1-0.20230811202059-187312fe86ed
...
replace github.com/argoproj/gitops-engine => github.com/gdsoumya/gitops-engine v0.0.0-20230712100447-40497092ef22
