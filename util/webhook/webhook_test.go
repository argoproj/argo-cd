...
func Test_getWebUrlRegex(t *testing.T) {
	tests := []struct {
		...
		{true, "https://example.com:443/org/repo", "ssh://git@ssh.example.com:22/org/repo", "https and ssh w/ ssh subdomain should match"},
		{true, "https://example.com:443/org/repo", "ssh://git@altssh.example.com:22/org/repo", "https and ssh w/ altssh subdomain should match"},
		{false, "https://example.com:443/org/repo", "ssh://git@unknown.example.com:22/org/repo", "https and ssh w/ unknown subdomain should not match"},
