...
import depot "github.com/argoproj/argo-cd/util/depot"
...
func (_m *Client) RevisionMetadata(path string, revision string) (*depot.RevisionMetadata, error) {
	ret := _m.Called(path, revision)

	var r0 *depot.RevisionMetadata
	if rf, ok := ret.Get(0).(func(string, string) *depot.RevisionMetadata); ok {
		r0 = rf(path, revision)
	} else {
		if ret.Get(0) != nil {
