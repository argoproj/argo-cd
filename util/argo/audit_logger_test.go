...
func captureLogEntries(ctx context.Context, run func(ctx context.Context)) string {
...
func TestLogAppProjEvent(t *testing.T) {
	...
	output := captureLogEntries(ctx, func(ctx context.Context) {
		logger.LogAppProjEvent(ctx, &proj, ei, "This is a test message", "")
	})
...
func TestLogAppEvent(t *testing.T) {
	...
	output := captureLogEntries(ctx, func(ctx context.Context) {
		logger.LogAppEvent(ctx, &app, ei, "This is a test message", "", nil)
	})
...
func TestLogResourceEvent(t *testing.T) {
	...
	output := captureLogEntries(ctx, func(ctx context.Context) {
		logger.LogResourceEvent(ctx, &res, ei, "This is a test message", "")
	})
