...
func ManageServerSideDiffDryRuns(config *rest.Config, openAPISchema openapi.Resources, onKubectlRun kube.OnKubectlRunFuncContext) (diff.KubeApplier, func(), error) {
	return kube.ManageServerSideDiffDryRunsContext(
		config,
		openAPISchema,
		tracer,
		logger,
