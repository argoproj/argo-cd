...
// touched.
func (ku *kubeUtil) CreateOrUpdateSecret(ns, name string, update updateFn) error {
	var s *corev1.Secret
	var err error
	var new bool
...
func (ku *kubeUtil) CreateOrUpdateSecretField(ns, name, field, value string) error {
...
func (ku *kubeUtil) CreateOrUpdateSecretData(ns, name string, data map[string][]byte, merge bool) error {
