...
import helm "github.com/argoproj/argo-cd/util/helm"
...
func (_m *Client) ExtractChart(chart string, version string) (string, util.Closer, error) {
	ret := _m.Called(chart, version)
	...
	var r1 util.Closer
	if rf, ok := ret.Get(1).(func(string, string) util.Closer); ok {
		r1 = rf(chart, version)
	} else {
		if ret.Get(1) != nil {
