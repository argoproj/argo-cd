...
import repo "github.com/argoproj/argo-cd/util/repo"
...
// RevisionMetadata provides a mock function with given fields: app, revision
func (_m *Repo) RevisionMetadata(app string, revision string) (*repo.RevisionMetadata, error) {
	ret := _m.Called(app, revision)
