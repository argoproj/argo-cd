...
//   - ctx context.Context
//   - projectName string
func (_e *Service_Expecter) GetAppProject(ctx interface{}, projectName interface{}) *Service_GetAppProject_Call {
...
func (_e *Service_Expecter) SetAppProjectInformer(informer interface{}) *Service_SetAppProjectInformer_Call {
