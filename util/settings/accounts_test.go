...
func TestUpdateAccount_SuccessfullyUpdated(t *testing.T) {
	...
	err := settingsManager.UpdateAccount(ctx, "test", func(_ context.Context, account *Account) error {
...
func TestUpdateAccount_UpdateAdminPassword(t *testing.T) {
	...
	err := settingsManager.UpdateAccount(ctx, "admin", func(_ context.Context, account *Account) error {
...
func TestUpdateAccount_AccountDoesNotExist(t *testing.T) {
	...
	err := settingsManager.UpdateAccount(ctx, "test1", func(_ context.Context, account *Account) error {
		account.Enabled = false
		return nil
	})
	require.Error(t, err)
