...
type ArgoCDSettings struct {
	...
	// UiPaginateAllDisabled indicates whether the "all" option in items per page dropdown is disabled
	UiPaginateAllDisabled bool `json:"uiPaginateAllDisabled,omitempty"` //nolint:revive //FIXME(var-naming)
...
const (
	...
	// settingUIPaginateAllDisabledKey designates the key for disabling the "all" option in items per page dropdown
	settingUIPaginateAllDisabledKey = "ui.paginateAllDisabled"
...
func updateSettingsFromConfigMap(settings *ArgoCDSettings, argoCDCM *corev1.ConfigMap) {
	...
	settings.UiPaginateAllDisabled = argoCDCM.Data[settingUIPaginateAllDisabledKey] == "true"
