...
func (_mock *Client) Fetch(revision string, depth int) error {
...
func (_c *Client_Fetch_Call) Run(run func(revision string, depth int)) *Client_Fetch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *Client_Fetch_Call) RunAndReturn(run func(revision string, depth int) error) *Client_Fetch_Call {
	_c.Call.Return(run)
	return _c
}
