...
// Checkout provides a mock function with given fields: revision, submoduleEnabled, submoduleRecursive
func (_m *Client) Checkout(revision string, submoduleEnabled bool, submoduleRecursive bool) error {
	ret := _m.Called(revision, submoduleEnabled, submoduleRecursive)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, bool, bool) error); ok {
		r0 = rf(revision, submoduleEnabled, submoduleRecursive)
	} else {
		r0 = ret.Error(0)
	}
...
// Submodule provides a mock function with given fields: recursive
func (_m *Client) Submodule(recursive bool) error {
	ret := _m.Called(recursive)
