...
// GetClusterByName provides a mock function with given fields: ctx, serverName
func (_m *ArgoDB) GetClusterByName(ctx context.Context, serverName string) (*v1alpha1.Cluster, error) {
...
// GetClusterByUrl provides a mock function with given fields: ctx, serverUrl
func (_m *ArgoDB) GetClusterByUrl(ctx context.Context, serverUrl string) (*v1alpha1.Cluster, error) {
...
type mockConstructorTestingTNewArgoDB interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewArgoDB(t mockConstructorTestingTNewArgoDB) *ArgoDB {
	mock := &ArgoDB{}
	mock.Mock.Test(t)
