...
func (db *db) GetProjectRepositories(_ context.Context, project string) ([]*appsv1.Repository, error) {
	return db.getRepositories(settings.ByProjectRepoIndexer, project)
}

func (db *db) GetProjectWriteRepositories(_ context.Context, project string) ([]*appsv1.Repository, error) {
