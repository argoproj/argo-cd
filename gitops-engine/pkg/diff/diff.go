...
import (
	...
	"github.com/argoproj/argo-cd/v2/gitops-engine/internal/kubernetes_vendor/pkg/api/v1/endpoints"
	"github.com/argoproj/argo-cd/v2/gitops-engine/pkg/diff/internal/fieldmanager"
	"github.com/argoproj/argo-cd/v2/gitops-engine/pkg/sync/resource"
	jsonutil "github.com/argoproj/argo-cd/v2/gitops-engine/pkg/utils/json"
	gescheme "github.com/argoproj/argo-cd/v2/gitops-engine/pkg/utils/kube/scheme"
	kubescheme "github.com/argoproj/argo-cd/v2/gitops-engine/pkg/utils/kube/scheme"
)
