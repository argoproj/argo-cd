...
import (
	...
	kubescheme "github.com/argoproj/argo-cd/gitops-engine/pkg/utils/kube/scheme"
...
func (m *appStateManager) getGVKParser(server *v1alpha1.Cluster) (kubescheme.GVKParser, error) {
