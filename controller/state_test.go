...
func Test_evaluateRevisionChanges(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Directory source without automated sync skips UpdateRevisionForPaths",
			source: &v1alpha1.ApplicationSource{
				RepoURL: "https://github.com/example/repo",
				Path:    "manifests",
			},
		...
		{
			name: "Directory source with automated sync calls UpdateRevisionForPaths",
			source: &v1alpha1.ApplicationSource{
				RepoURL: "https://github.com/example/repo",
				Path:    "manifests",
			},
		...
		{
			name: "Non-Directory source without automated sync calls UpdateRevisionForPaths",
			source: &v1alpha1.ApplicationSource{
				RepoURL: "https://github.com/example/repo",
				Path:    "manifests",
			},
