...
func (m *appStateManager) getRepoObjs(app *v1alpha1.Application, source v1alpha1.ApplicationSource, appLabelKey, revision string, noCache bool) ([]*unstructured.Unstructured, []*unstructured.Unstructured, *repoapiclient.ManifestResponse, error) {
	...
	manifestInfo, err := repoClient.GenerateManifest(context.Background(), &repoapiclient.ManifestRequest{
		Repo:              repo,
		HelmRepos:         helmRepos,
		Revision:          revision,
		NoCache:           noCache,
...
func (m *appStateManager) CompareAppState(app *v1alpha1.Application, revision string, source v1alpha1.ApplicationSource, noCache bool, localManifests []string) (*comparisonResult, error) {
	...
	var manifestInfo *repoapiclient.ManifestResponse
