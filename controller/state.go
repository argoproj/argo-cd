...
func (m *appStateManager) CompareAppState(app *v1alpha1.Application, project *v1alpha1.AppProject, revisions []string, sources []v1alpha1.ApplicationSource, noCache bool, noRevisionCache bool, localManifests []string, hasMultipleSources bool, rollback bool) (*comparisonResult, error) {
	...
	if err != nil {
		return unknownComparisonResults(app, hasMultipleSources, revisions)
	}
	...
	revisionUpdated, err := m.fetchManifests(cmp, revisions, sources, noRevisionCache, localManifests, rollback, appLabelKey)
...
func unknownComparisonResults(app *v1alpha1.Application, hasMultipleSources bool, revisions []string) (*comparisonResult, error) {
	if hasMultipleSources {
...
func (cmp *appStateCmp) useDiffCache(sources []v1alpha1.ApplicationSource, manifestRevisions []string, statusRefreshTimeout time.Duration, serverSideDiff bool) bool {
	...
	if !specEqualsCompareTo(cmp.app.Spec, cmp.app.Status.Sync.ComparedTo) {
...
func (m *appStateManager) fetchManifests(cmp *appStateCmp, revisions []string, sources []v1alpha1.ApplicationSource, noRevisionCache bool, localManifests []string, rollback bool, appLabelKey string) (bool, error) {
	var err error
	...
	if len(localManifests) == 0 {
		...
		cmp.targetObjs, cmp.manifestInfos, revisionUpdated, err = m.GetRepoObjs(cmp.app, sources, appLabelKey, revisions, cmp.noCache, noRevisionCache, cmp.verifySignature, cmp.project, rollback, true)
		if err != nil {
