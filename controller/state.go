...
func unknownComparisonResults(app *v1alpha1.Application, hasMultipleSources bool, revisions []string) *comparisonResult {
	cr := &comparisonResult{
		syncStatus: &v1alpha1.SyncStatus{
	...
	if hasMultipleSources {
		cr.syncStatus.Revisions = revisions
	} else {
		cr.syncStatus.Revision = revisions[0]
	}
	return cr
}
