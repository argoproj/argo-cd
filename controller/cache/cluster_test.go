...
func TestGetChildren(t *testing.T) {
	...
	assert.Equal(t, []appv1.ResourceNode{{
		...
		Group:           "",
		Version:         "v1",
		Tags:            []appv1.InfoItem{{Name: "Containers", Value: "0/0"}},
...
func TestUpdateResourceTags(t *testing.T) {
	...
	assert.Equal(t, []appv1.InfoItem{{Name: "Containers", Value: "0/1"}}, podNode.tags)
	...
	assert.NotNil(t, podNode)
	assert.Equal(t, []appv1.InfoItem{{Name: "Status Reason", Value: "ExitCode:-1"}, {Name: "Containers", Value: "0/1"}}, podNode.tags)
}
