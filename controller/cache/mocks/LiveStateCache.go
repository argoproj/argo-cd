...
func (_m *LiveStateCache) IterateHierarchy(server string, key kube.ResourceKey, action func(v1alpha1.ResourceNode, string) (bool, error)) error {
	ret := _m.Called(server, key, action)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, kube.ResourceKey, func(v1alpha1.ResourceNode, string) (bool, error)) error); ok {
...
type mockConstructorTestingTNewLiveStateCache interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewLiveStateCache(t mockConstructorTestingTNewLiveStateCache) *LiveStateCache {
	mock := &LiveStateCache{}
	mock.Mock.Test(t)
