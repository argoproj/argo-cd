...
func TestShouldHashManifest(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "argocd.argoproj.io/ignore-resources-update=true",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"argocd.argoproj.io/ignore-resources-update": "true"},
			want:        true,
		},
		{
			name:        "argocd.argoproj.io/ignore-resources-update=invalid",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"argocd.argoproj.io/ignore-resources-update": "invalid"},
			want:        false,
		},
		{
			name:        "argocd.argoproj.io/ignore-resources-update=false",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"argocd.argoproj.io/ignore-resources-update": "false"},
			want:        false,
		},
	}
