...
export const Login: FC<RouteComponentProps<{}>> = props => {
    ...
    const handleSubmit = async (params: LoginForm) => {
        await login(params.username, params.password, returnUrl);
    };

    const handleValidateError = (params: LoginForm) => ({
    ...
    return (
        <div className='login'>
            ...
            <div className='login__box'>
                ...
                {authSettings && !authSettings.userLoginsDisabled && (
                    <Form onSubmit={handleSubmit} validateError={handleValidateError}>
                        {formApi => (
