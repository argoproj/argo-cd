        ...
        <div className='application-summary'>
            {source.plugin && typeof source.plugin.name === 'string' && source.plugin.name !== '' && (
                <div className='white-box'>
                    ...
                    <a href='https://argo-cd.readthedocs.io/en/latest/operator-manual/upgrading/2.4-2.5/#argocd-cm-plugins-cmps-are-deprecated'>2.4-to-2.5 upgrade notes</a> for details.
                </div>
            )}
            <EditablePanel
                save={updateApp}
