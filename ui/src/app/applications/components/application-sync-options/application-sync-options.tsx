...
export const PRUNE_WARNING = `The resources will be synced using '--prune' that is a potentially destructive action and will immediately delete resources from your target cluster. Consider the option carefully.`;
