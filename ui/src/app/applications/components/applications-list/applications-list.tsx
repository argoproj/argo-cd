                                                    ...
                                                    return (
                                                        <React.Fragment>
                                                            <FlexTopBar
                                                                toolbar={{
                                                                    tools: (
                                                                        <ApplicationsToolbar applications={applications} pref={pref} ctx={ctx} healthBarPrefs={healthBarPrefs} />
                                                                    ),
                                                                    actionMenu: {
                                                                        items: [
                                                                            {
                                                                ...
                                                                load={() =>
                                                                    observableQuery$.pipe(
                                                                        mergeMap(params => {
                                                                            ...
                                                                            return (
                                                                                (syncApp && from(services.applications.get(syncApp, appNamespace, objectListKind))) || from([null])
                                                                            );
                                                                        })
                                                                    )
                                                                }>
