    ...
    return (
        <div className='application-status-panel row'>
            ...
            <div className='application-status-panel__item columns small-4' style={{position: 'relative'}}>
                ...
                <div className='application-status-panel__item-name'><RevisionMetadataPanel applicationName={application.metadata.name} revision={application.spec.source.targetRevision}/></div>
            </div>
            {appOperationState && (
