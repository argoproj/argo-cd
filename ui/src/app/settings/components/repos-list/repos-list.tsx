...
export const ReposList = ({match, location}: RouteComponentProps) => {
        ...
        switch (method) {
            ...
            case ConnectionMethod.GITHUBAPP: {
                ...
                return {
                    ...
                    ...validateGitHubAppCredentials(githubAppValues, credsTemplate.current),
    ...
    const connectGitHubAppRepo = async (params: NewGitHubAppRepoParams) => {
        const normalizedParams = normalizeGitHubAppCredentials(params);
        if (credsTemplate.current) {
            createGitHubAppCreds({
                url: normalizedParams.url,
                githubAppPrivateKey: normalizedParams.githubAppPrivateKey,
                githubAppId: normalizedParams.githubAppId,
                githubAppInstallationId: normalizedParams.githubAppInstallationId,
                githubAppEnterpriseBaseURL: normalizedParams.githubAppEnterpriseBaseURL,
                tlsClientCertData: normalizedParams.tlsClientCertData,
                tlsClientCertKey: normalizedParams.tlsClientCertKey,
                proxy: normalizedParams.proxy,
                noProxy: normalizedParams.noProxy,
                write: normalizedParams.write
            });
        } else {
            setConnecting(true);
            try {
                if (normalizedParams.write) {
