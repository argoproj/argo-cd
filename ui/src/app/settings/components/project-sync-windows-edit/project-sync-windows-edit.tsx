...
const AttributeWrapper = ({fieldApi, deleteApp}: AttributeProps) => {
    const getApplication = (): string => {
        return fieldApi.getValue();
    };

    const setApplication = (application: string) => {
        fieldApi.setValue(application);
    };
...
const ScheduleWrapper = ({fieldApi}: ScheduleProps) => {
