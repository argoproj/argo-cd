...
export function ProjectDetails(props: RouteComponentProps<{name: string}>) {
    const ctx = useContext(Context);
    const [token, setToken] = useState('');
    const projectRoleFormApi = useRef<FormApi>(null);
    const projectSyncWindowsFormApi = useRef<FormApi>(null);
    const loader = useRef<DataLoader>(null);
                                    ...
                                    <SlidingPanel
                                        ...
                                        {(params.get('editRole') !== null || params.get('newRole') === 'true') && (
                                            <ProjectRoleEditPanel
                                                ...
                                                getApi={(api: FormApi) => (projectRoleFormApi.current = api)}
                                    ...
                                    <SlidingPanel
                                        ...
                                        {(params.get('editWindow') !== null || params.get('newWindow') === 'true') && (
                                            <ProjectSyncWindowsEditPanel
                                                ...
                                                getApi={(api: FormApi) => (projectSyncWindowsFormApi.current = api)}
