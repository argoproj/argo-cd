...
// import { ApplicationSetsList } from '../../applications/components/applications-list/applications-list';
import { ApplicationSetsList } from '../../applications/components/applicationsets-list/applications-list';
// import {ApplicationSetsList} from './../../applicationsets/components/applications-list/applications-list';
...
export const SettingsContainer = (props: RouteComponentProps<any>) => (
    <Switch>
        ...
        <Route exact={true} path={`${props.match.path}/applicationsets`} component={ApplicationSetsList} />
