...
export const EntitiesTable = (modelName, props: {
    entities: models.ApplicationSet[];
    ...
    useKeybinding({
        ...
        action: () => {
            if (selectedApp > -1) {
                ctxh.navigation.goto(`/applicationsets/${props.applications[selectedApp].metadata.name}`);
                return true;
            }
            return false;
        }
                                        ...
                                        <div
                                            ...
                                            <div className='columns small-4'>
                                                <div className='row'>
                                                    ...
                                                    {/* <div className='columns small-12 xxlarge-6'>{appSet.spec.project}</div> */}
                                                </div>
                                                <div className='row'>
                                                    <div className=' columns small-2' />
                                                ...
                                                <div className='row'>
                                                    ...
                                                    <div className='columns small-12 xxlarge-10 applications-table-source' style={{position: 'relative'}}>
                                                        ...
                                                        <div className='applications-table-source__labels'>
                                                            <ApplicationSetsLabels app={appSet} />
                                                        </div>
                                                    </div>
                                                </div>
                                          {/*      <div className='row'>
                                            ...
                                            {/* <AppUtils.HealthStatusIcon state={app.status.health} /> <span>{app.status.health.status}</span> <br /> */}
                                                ...
                                                <DropDownMenu
                                                    ...
                                                    items={[
                                                        ...
                                                        {title: 'Delete', action: () => props.deleteApplicationSet(appSet.metadata.name, appSet.metadata.namespace)}
                                                    ]}
                                                />
                                            </div>
                                        </div>
