...
import {Form, FormApi, FormState, FormValues} from 'react-form';
...
export const EditableSection = <T extends {} = {}>({
    title,
    uniqueId,
    noReadonlyMode,
    save,
    ...
    const onFormSubmit = useCallback(
        ...
        [save, ctx.notifications, updateButtons, onModeSwitch]
    );

    const ButtonInReadMode = () => (
    ...
    const EditableSectionButtons = () => (
        <>
            <div
                ...
                {isEditing ? <ButtonInEditMode /> : <ButtonInReadMode />}
            </div>
        </>
    );
    ...
    return (
        <div key={uniqueId}>
            {!noReadonlyMode && save && <EditableSectionButtons />}
            {title && (
