...
interface AbstractSidebarProps {
    onVersionClick: () => void;
    navItems: {path: string; iconClassName: string; title: string; tooltip?: string}[];
    pref: any;
}

// interface SidebarProps extends AbstractSidebarProps{
//     pref: ViewPreferences;
// }

// interface AppSetSidebarProps extends AbstractSidebarProps{
...
export const Sidebar = (props: AbstractSidebarProps) => {
...
//             <div className='sidebar__container'>
//                 <div className='sidebar__logo'>
//                     <div onClick={() => services.appSetViewPreferences.updatePreferences({...props.pref, hideSidebar: !props.pref.hideSidebar})} className='sidebar__collapse-button'>
//                         <i className={`fas fa-arrow-${props.pref.hideSidebar ? 'right' : 'left'}`} />
//                     </div>
//                     {!props.pref.hideSidebar && (
//                         <div className='sidebar__logo-container'>
