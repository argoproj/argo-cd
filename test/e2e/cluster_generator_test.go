...
func TestSimpleClusterGeneratorAddingCluster(t *testing.T) {
	...
	Given(t).
		...
		// Delete the ApplicationSet, and verify it deletes the Applications
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{expectedAppCluster1, expectedAppCluster2}))
}
...
func TestSimpleClusterGeneratorDeletingCluster(t *testing.T) {
	...
	Given(t).
		...
		// Delete the ApplicationSet, and verify it deletes the Applications
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{expectedAppCluster1}))
}
...
`,
		...
		// Delete the ApplicationSet, and verify it deletes the Applications
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{expectedAppCluster2}))
}
