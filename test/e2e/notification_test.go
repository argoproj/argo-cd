...
func TestNotificationsListServices(t *testing.T) {
	...
	ctx.When().
		...
		Then().Services(t.Context(), func(services *notification.ServiceList, err error) {
...
func TestNotificationsListTemplates(t *testing.T) {
	...
	ctx.When().
		...
		Then().Templates(t.Context(), func(templates *notification.TemplateList, err error) {
		require.NoError(t, err)
...
func TestNotificationsListTriggers(t *testing.T) {
	...
	ctx.When().
		...
		Then().Triggers(t.Context(), func(triggers *notification.TriggerList, err error) {
		require.NoError(t, err)
