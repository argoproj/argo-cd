...
func TestSimpleListGeneratorExternalNamespace(t *testing.T) {
	...
	Given(t).
		...
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{*expectedAppNewMetadata}))
}
...
func TestSimpleListGeneratorExternalNamespaceNoConflict(t *testing.T) {
	...
	Given(t).
		...
		Expect(ApplicationsExist([]v1alpha1.Application{expectedAppExternalNamespace2})).
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{expectedAppExternalNamespace2}))
}
...
func TestRenderHelmValuesObject(t *testing.T) {
	...
	Given(t).
		...
		// Delete the ApplicationSet, and verify it deletes the Applications
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{expectedApp}))
}
...
func TestSyncPolicyCreateUpdate(t *testing.T) {
	...
	Given(t).
		...
		When().
		Delete(false).Then().Expect(ApplicationsExist([]v1alpha1.Application{*expectedAppNewMetadata}))
}
...
func TestSyncPolicyCreateDelete(t *testing.T) {
	...
	Given(t).
		...
		When().
		Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{*expectedAppNewNamespace}))
}
...
func TestSyncPolicyCreateOnly(t *testing.T) {
	...
	Given(t).
		...
		// So AppSet deletion will be reflected, but all the applications it generates will still exist
		When().
		Delete(false).Then().Expect(ApplicationsExist([]v1alpha1.Application{*expectedAppNewNamespace}))
}
...
func TestApplicationSetAPIListResourceEvents(t *testing.T) {
	...
	ctx.When().Create(v1alpha1.ApplicationSet{
		...
		When().Delete(false).Then().Expect(ApplicationsDoNotExist([]v1alpha1.Application{}))
}
