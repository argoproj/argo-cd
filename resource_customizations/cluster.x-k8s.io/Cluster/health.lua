function setStatusBasedOnConditions(obj, hs)
    conditions = nil
    ...
    for i, condition in ipairs(conditions) do
        ...
        -- Transient conditions, leading to Progressing if not False
        if
            (
        ...
        -- Transient conditions, leading to Progressing if not True
        if
            (
...
function setStatusBasedOnPhase(obj, hs)
...
setStatusBasedOnConditions(obj, hs)
if hs.status == "Degraded" or hs.status == "Progressing" then
    return hs
end

setStatusBasedOnPhase(obj, hs)
