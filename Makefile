...
.PHONY: lint
lint:
	cd /tmp && GO111MODULE=on go get github.com/jstemmer/go-junit-report@v0.0.0-20190106144839-af01ea7f8024
	cd /tmp && GO111MODULE=on go get github.com/golangci/golangci-lint@v1.20
