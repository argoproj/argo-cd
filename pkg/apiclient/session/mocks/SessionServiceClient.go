...
type mockConstructorTestingTNewSessionServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSessionServiceClient(t mockConstructorTestingTNewSessionServiceClient) *SessionServiceClient {
