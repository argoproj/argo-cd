...
type GetUserInfoResponse struct {
	...
	// rbacSubject is the identity to reference in RBAC policies for the current user. It matches
	// username except when local-user strict mode is enabled, where local accounts are suffixed with
	// "@local" (e.g. "sally@local"). It is intended for display only; username remains the real account name.
	RbacSubject          string   `protobuf:"bytes,5,opt,name=rbacSubject,proto3" json:"rbacSubject,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetUserInfoResponse) GetRbacSubject() string {
	if m != nil {
		return m.RbacSubject
	}
	return ""
}
...
var fileDescriptor_87870a51a62685ed = []byte{
	...
	,
}
...
func (m *GetUserInfoResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RbacSubject) > 0 {
		i -= len(m.RbacSubject)
		copy(dAtA[i:], m.RbacSubject)
		i = encodeVarintSession(dAtA, i, uint64(len(m.RbacSubject)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Groups) > 0 {
...
func (m *GetUserInfoResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RbacSubject", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RbacSubject = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSession(dAtA[iNdEx:])
