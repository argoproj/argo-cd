...
func (*RepoAppsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{0}
}
...
func (*AppInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{1}
}
...
func (*RepoAppDetailsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{2}
}
...
func (*RepoAppsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{3}
}
...
func (*RepoQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{4}
}
...
func (*RepoAccessQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{5}
}
...
func (*RepoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{6}
}
...
func (*RepoCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{7}
}
...
func (*RepoUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_14cf0cb00b2c9f4b, []int{8}
}
...
func init() {
	proto.RegisterFile("server/repository/repository.proto", fileDescriptor_repository_14cf0cb00b2c9f4b)
}

var fileDescriptor_repository_14cf0cb00b2c9f4b = []byte{
	...
	,
}
