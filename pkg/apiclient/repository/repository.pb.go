...
type RepoAppDetailsQuery struct {
	...
	Helm                 *repoapiclient.HelmAppDetailsQuery    `protobuf:"bytes,4,opt,name=helm" json:"helm,omitempty"`
	Ksonnet              *repoapiclient.KsonnetAppDetailsQuery `protobuf:"bytes,5,opt,name=ksonnet" json:"ksonnet,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_unrecognized     []byte                                `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (m *RepoAppDetailsQuery) GetHelm() *repoapiclient.HelmAppDetailsQuery {
	if m != nil {
		return m.Helm
	}
	return nil
...
func (m *RepoAppDetailsQuery) GetKsonnet() *repoapiclient.KsonnetAppDetailsQuery {
	if m != nil {
		return m.Ksonnet
	}
	return nil
...
type RepositoryServiceClient interface {
	...
	GetAppDetails(ctx context.Context, in *RepoAppDetailsQuery, opts ...grpc.CallOption) (*repoapiclient.RepoAppDetailsResponse, error)
...
func (c *repositoryServiceClient) GetAppDetails(ctx context.Context, in *RepoAppDetailsQuery, opts ...grpc.CallOption) (*repoapiclient.RepoAppDetailsResponse, error) {
	out := new(repoapiclient.RepoAppDetailsResponse)
...
type RepositoryServiceServer interface {
	...
	// GetAppDetails returns application details by given path
	GetAppDetails(context.Context, *RepoAppDetailsQuery) (*repoapiclient.RepoAppDetailsResponse, error)
	// Create creates a repo
...
func (m *RepoAppDetailsQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Helm == nil {
				m.Helm = &repoapiclient.HelmAppDetailsQuery{}
			}
		...
		case 5:
			...
			if m.Ksonnet == nil {
				m.Ksonnet = &repoapiclient.KsonnetAppDetailsQuery{}
			}
