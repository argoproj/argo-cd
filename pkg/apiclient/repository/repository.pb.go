...
func (*RepoAppsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{0}
}
...
func (*AppInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{1}
}
...
func (*RepoAppDetailsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{2}
}
...
func (*RepoAppsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{3}
}
...
func (*RepoQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{4}
}
...
func (*RepoAccessQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{5}
}
...
func (*RepoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{6}
}
...
func (*RepoCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{7}
}
...
func (*RepoUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_9121b7c544dae8a6, []int{8}
}
...
type RepositoryServiceClient interface {
	...
	ListRepos(ctx context.Context, in *RepoQuery, opts ...grpc.CallOption) (*v1alpha1.RepositoryList, error)
	// ListApps returns list of apps in the repo
	ListRepoApps(ctx context.Context, in *RepoAppsQuery, opts ...grpc.CallOption) (*RepoAppsResponse, error)
	...
	CreateRepo(ctx context.Context, in *RepoCreateRequest, opts ...grpc.CallOption) (*v1alpha1.Repository, error)
	// Update updates a repo
	UpdateRepo(ctx context.Context, in *RepoUpdateRequest, opts ...grpc.CallOption) (*v1alpha1.Repository, error)
	// Delete deletes a repo
	DeleteRepo(ctx context.Context, in *RepoQuery, opts ...grpc.CallOption) (*RepoResponse, error)
...
func (c *repositoryServiceClient) ListRepos(ctx context.Context, in *RepoQuery, opts ...grpc.CallOption) (*v1alpha1.RepositoryList, error) {
	out := new(v1alpha1.RepositoryList)
	err := c.cc.Invoke(ctx, "/repository.RepositoryService/ListRepos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repositoryServiceClient) ListRepoApps(ctx context.Context, in *RepoAppsQuery, opts ...grpc.CallOption) (*RepoAppsResponse, error) {
	out := new(RepoAppsResponse)
	err := c.cc.Invoke(ctx, "/repository.RepositoryService/ListRepoApps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repositoryServiceClient) CreateRepo(ctx context.Context, in *RepoCreateRequest, opts ...grpc.CallOption) (*v1alpha1.Repository, error) {
	out := new(v1alpha1.Repository)
	err := c.cc.Invoke(ctx, "/repository.RepositoryService/CreateRepo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repositoryServiceClient) UpdateRepo(ctx context.Context, in *RepoUpdateRequest, opts ...grpc.CallOption) (*v1alpha1.Repository, error) {
	out := new(v1alpha1.Repository)
	err := c.cc.Invoke(ctx, "/repository.RepositoryService/UpdateRepo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *repositoryServiceClient) DeleteRepo(ctx context.Context, in *RepoQuery, opts ...grpc.CallOption) (*RepoResponse, error) {
	out := new(RepoResponse)
	err := c.cc.Invoke(ctx, "/repository.RepositoryService/DeleteRepo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepositoryServiceServer interface {
	// List returns list of repos
	ListRepos(context.Context, *RepoQuery) (*v1alpha1.RepositoryList, error)
	// ListApps returns list of apps in the repo
	ListRepoApps(context.Context, *RepoAppsQuery) (*RepoAppsResponse, error)
	// GetAppDetails returns application details by given path
	GetAppDetails(context.Context, *RepoAppDetailsQuery) (*apiclient.RepoAppDetailsResponse, error)
	// Create creates a repo
	CreateRepo(context.Context, *RepoCreateRequest) (*v1alpha1.Repository, error)
	// Update updates a repo
	UpdateRepo(context.Context, *RepoUpdateRequest) (*v1alpha1.Repository, error)
	// Delete deletes a repo
	DeleteRepo(context.Context, *RepoQuery) (*RepoResponse, error)
	// ValidateAccess validates access to a repository with given parameters
...
func _RepositoryService_ListRepos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepositoryService/ListRepos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).ListRepos(ctx, req.(*RepoQuery))
	}
	return interceptor(ctx, in, info, handler)
}

func _RepositoryService_ListRepoApps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RepoAppsQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServiceServer).ListRepoApps(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepositoryService/ListRepoApps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).ListRepoApps(ctx, req.(*RepoAppsQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RepositoryService_CreateRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepositoryService/CreateRepo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).CreateRepo(ctx, req.(*RepoCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RepositoryService_UpdateRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RepoUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServiceServer).UpdateRepo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepositoryService/UpdateRepo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).UpdateRepo(ctx, req.(*RepoUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RepositoryService_DeleteRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RepoQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RepositoryServiceServer).DeleteRepo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/repository.RepositoryService/DeleteRepo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).DeleteRepo(ctx, req.(*RepoQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RepositoryService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListRepoApps",
			Handler:    _RepositoryService_ListRepoApps_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _RepositoryService_UpdateRepo_Handler,
		},
		{
			MethodName: "DeleteRepo",
			Handler:    _RepositoryService_DeleteRepo_Handler,
		},
		{
...
func init() {
	proto.RegisterFile("server/repository/repository.proto", fileDescriptor_repository_9121b7c544dae8a6)
}

var fileDescriptor_repository_9121b7c544dae8a6 = []byte{
	...
	,
}
