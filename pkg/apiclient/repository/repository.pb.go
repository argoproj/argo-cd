...
type RepoAccessQuery struct {
	...
	// Whether to use AWS ECR workload identity for authentication
	UseAWSECRWorkloadIdentity bool `protobuf:"varint,23,opt,name=useAWSECRWorkloadIdentity,proto3" json:"useAWSECRWorkloadIdentity,omitempty"`
	// AWS ECR region for authentication
	AwsECRRegion string `protobuf:"bytes,24,opt,name=awsECRRegion,proto3" json:"awsECRRegion,omitempty"`
	// AWS ECR registry ID for cross-account access
	AwsECRRegistryID     string   `protobuf:"bytes,25,opt,name=awsECRRegistryID,proto3" json:"awsECRRegistryID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RepoAccessQuery) GetUseAWSECRWorkloadIdentity() bool {
	if m != nil {
		return m.UseAWSECRWorkloadIdentity
	}
	return false
}

func (m *RepoAccessQuery) GetAwsECRRegion() string {
	if m != nil {
		return m.AwsECRRegion
	}
	return ""
}

func (m *RepoAccessQuery) GetAwsECRRegistryID() string {
	if m != nil {
		return m.AwsECRRegistryID
	}
	return ""
}
...
var fileDescriptor_8d38260443475705 = []byte{
	...
	,
}
...
func (m *RepoAccessQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AwsECRRegistryID) > 0 {
		i -= len(m.AwsECRRegistryID)
		copy(dAtA[i:], m.AwsECRRegistryID)
		i = encodeVarintRepository(dAtA, i, uint64(len(m.AwsECRRegistryID)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
	}
	if len(m.AwsECRRegion) > 0 {
		i -= len(m.AwsECRRegion)
		copy(dAtA[i:], m.AwsECRRegion)
		i = encodeVarintRepository(dAtA, i, uint64(len(m.AwsECRRegion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc2
	}
	if m.UseAWSECRWorkloadIdentity {
		i--
		if m.UseAWSECRWorkloadIdentity {
			dAtA[i] = 1
		} else {
...
func (m *RepoAccessQuery) Size() (n int) {
	...
	l = len(m.AwsECRRegion)
	if l > 0 {
		n += 2 + l + sovRepository(uint64(l))
	}
	l = len(m.AwsECRRegistryID)
	if l > 0 {
		n += 2 + l + sovRepository(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *RepoAccessQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseAWSECRWorkloadIdentity", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UseAWSECRWorkloadIdentity = bool(v != 0)
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AwsECRRegion", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AwsECRRegion = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AwsECRRegistryID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AwsECRRegistryID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRepository(dAtA[iNdEx:])
