...
func (m *MaintenanceStateQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MaintenanceStateQuery.Merge(m, src)
}
...
type MaintenanceResponse struct {
	Windows              []*v1alpha1.ProjectMaintenanceWindow `protobuf:"bytes,1,rep,name=windows,proto3" json:"windows,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}
...
func (*UnimplementedProjectServiceServer) GetMaintenanceState(ctx context.Context, req *MaintenanceStateQuery) (*MaintenanceResponse, error) {
...
func (m *MaintenanceStateQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
