...
const file_server_application_application_proto_rawDesc = "" +
	"\n" +
	"$server/application/application.proto\x12\vapplication\x1a\x1cgoogle/api/annotations.proto\x1a4k8s.io/apimachinery/pkg/apis/meta/v1/generated.proto\x1aLgithub.com/argoproj/argo-cd/v3/pkg/apis/application/v1alpha1/generated.proto\x1aEgithub.com/argoproj/argo-cd/v3/reposerver/repository/repository.proto\x1a9github.com/argoproj/argo-cd/v3/server/events/events.proto\"\xf4\x01\n" +
	...
	"\aproject\x18\x04 \x01(\tR\aproject2\xe2'\n" +
	"\x12ApplicationService\x12\x92\x01\n" +
	"\x04List\x12\x1d.application.ApplicationQuery\x1aM.github.com.argoproj.argo_cd.v3.pkg.apis.application.v1alpha1.ApplicationList\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/api/v1/applications\x12\x80\x01\n" +
	"\x12ListResourceEvents\x12+.application.ApplicationResourceEventsQuery\x1a\x11.events.EventList\"*\x82\xd3\xe4\x93\x02$\x12\"/api/v1/applications/{name}/events\x12\xa2\x01\n" +
...
var file_server_application_application_proto_depIdxs = []int32{
	...
	49, // 52: application.ApplicationService.ListResourceEvents:output_type -> events.EventList
