...
type ApplicationSortBy int32

const (
	// unspecified, sort by name
	ApplicationSortBy_ASB_UNSPECIFIED ApplicationSortBy = 0
	// sort by .Name
	ApplicationSortBy_ASB_NAME ApplicationSortBy = 1
	// sort by .Metadata.CreateTimestamp
	ApplicationSortBy_ASB_CREATED_AT ApplicationSortBy = 2
	// sort by .Status.OperationState.FinishedAt
	ApplicationSortBy_ASB_SYNCHRONIZED ApplicationSortBy = 3
)

var ApplicationSortBy_name = map[int32]string{
	0: "ASB_UNSPECIFIED",
	1: "ASB_NAME",
	2: "ASB_CREATED_AT",
	3: "ASB_SYNCHRONIZED",
...
var ApplicationSortBy_value = map[string]int32{
	"ASB_UNSPECIFIED":  0,
	"ASB_NAME":         1,
	"ASB_CREATED_AT":   2,
	"ASB_SYNCHRONIZED": 3,
...
func (x ApplicationSortBy) Enum() *ApplicationSortBy {
	p := new(ApplicationSortBy)
	*p = x
	return p
}

func (x ApplicationSortBy) String() string {
	return proto.EnumName(ApplicationSortBy_name, int32(x))
}

func (x *ApplicationSortBy) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ApplicationSortBy_value, data, "ApplicationSortBy")
	if err != nil {
		return err
	}
	*x = ApplicationSortBy(value)
	return nil
}

func (ApplicationSortBy) EnumDescriptor() ([]byte, []int) {
...
type ApplicationQuery struct {
	...
	// Deprecated: use options.projects instead
	...
	// Deprecated: use options.selector instead
	...
	// Deprecated: use options.repos instead
	...
	// the options to restrict returned list applications
	Options              *ApplicationListOptions `protobuf:"bytes,9,opt,name=options" json:"options,omitempty"`
...
func (m *ApplicationQuery) GetOptions() *ApplicationListOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
type ApplicationListOptions struct {
	...
	MinName *string `protobuf:"bytes,1,opt,name=minName" json:"minName,omitempty"`
	// the application name to end at (app with max name is included in response)
	MaxName *string `protobuf:"bytes,2,opt,name=maxName" json:"maxName,omitempty"`
	// the repos filter, ignore if the field repo was defined
	Repos []string `protobuf:"bytes,3,rep,name=repos" json:"repos,omitempty"`
	// the clusters filter
	...
	AutoSyncEnabled *bool `protobuf:"varint,6,opt,name=autoSyncEnabled" json:"autoSyncEnabled,omitempty"`
	// the sync status filter
	SyncStatuses []string `protobuf:"bytes,7,rep,name=syncStatuses" json:"syncStatuses,omitempty"`
	// the health status filter
	HealthStatuses []string `protobuf:"bytes,8,rep,name=healthStatuses" json:"healthStatuses,omitempty"`
	// search
	Search *string `protobuf:"bytes,9,opt,name=search" json:"search,omitempty"`
	// offset
	Offset *int64 `protobuf:"varint,10,opt,name=offset" json:"offset,omitempty"`
	// limit
	Limit *int64 `protobuf:"varint,11,opt,name=limit" json:"limit,omitempty"`
	// sort by enum=name;created-at;synchronized
	SortBy               *ApplicationSortBy `protobuf:"varint,12,opt,name=sortBy,enum=application.ApplicationSortBy" json:"sortBy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *ApplicationListOptions) Reset()         { *m = ApplicationListOptions{} }
func (m *ApplicationListOptions) String() string { return proto.CompactTextString(m) }
func (*ApplicationListOptions) ProtoMessage()    {}
func (*ApplicationListOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{1}
}
func (m *ApplicationListOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApplicationListOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApplicationListOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ApplicationListOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationListOptions.Merge(m, src)
}
func (m *ApplicationListOptions) XXX_Size() int {
	return m.Size()
}
func (m *ApplicationListOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_ApplicationListOptions.DiscardUnknown(m)
}

var xxx_messageInfo_ApplicationListOptions proto.InternalMessageInfo

func (m *ApplicationListOptions) GetMinName() string {
...
func (m *ApplicationListOptions) GetMaxName() string {
...
func (m *ApplicationListOptions) GetRepos() []string {
	if m != nil {
		return m.Repos
	}
	return nil
...
func (m *ApplicationListOptions) GetClusters() []string {
	if m != nil {
		return m.Clusters
	}
	return nil
...
func (m *ApplicationListOptions) GetNamespaces() []string {
	if m != nil {
		return m.Namespaces
	}
	return nil
...
func (m *ApplicationListOptions) GetAutoSyncEnabled() bool {
...
func (m *ApplicationListOptions) GetSyncStatuses() []string {
	if m != nil {
...
func (m *ApplicationListOptions) GetHealthStatuses() []string {
	if m != nil {
...
func (m *ApplicationListOptions) GetSearch() string {
...
func (m *ApplicationListOptions) GetOffset() int64 {
...
func (m *ApplicationListOptions) GetLimit() int64 {
...
func (m *ApplicationListOptions) GetSortBy() ApplicationSortBy {
	if m != nil && m.SortBy != nil {
		return *m.SortBy
	}
	return ApplicationSortBy_ASB_UNSPECIFIED
}

type ApplicationListResponse struct {
	Items                []*v1alpha1.Application `protobuf:"bytes,1,rep,name=items" json:"items,omitempty"`
	Stats                *ApplicationListStats   `protobuf:"bytes,2,req,name=stats" json:"stats,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *ApplicationListResponse) GetItems() []*v1alpha1.Application {
	if m != nil {
		return m.Items
	}
	return nil
...
func (m *ApplicationListResponse) GetStats() *ApplicationListStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
// Stats for the application list
...
type ApplicationListStats struct {
	...
	// the number of applications based on the sync status
	TotalBySyncStatus map[string]int64 `protobuf:"bytes,2,rep,name=totalBySyncStatus" json:"totalBySyncStatus,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// the number of applications based on the health status
	TotalByHealthStatus map[string]int64 `protobuf:"bytes,3,rep,name=totalByHealthStatus" json:"totalByHealthStatus,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// the number of applications with auto-sync enabled
	AutoSyncEnabledCount *int64 `protobuf:"varint,4,req,name=autoSyncEnabledCount" json:"autoSyncEnabledCount,omitempty"`
	// all destinations for the applications returned
	Destinations []*v1alpha1.ApplicationDestination `protobuf:"bytes,5,rep,name=destinations" json:"destinations,omitempty"`
	// all namespaces for the applications returned
	Namespaces []string `protobuf:"bytes,6,rep,name=namespaces" json:"namespaces,omitempty"`
	// all labels for the applications returned
	Labels               []*ApplicationLabelStats `protobuf:"bytes,7,rep,name=labels" json:"labels,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *ApplicationListStats) Reset()         { *m = ApplicationListStats{} }
func (m *ApplicationListStats) String() string { return proto.CompactTextString(m) }
func (*ApplicationListStats) ProtoMessage()    {}
func (*ApplicationListStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{3}
}
func (m *ApplicationListStats) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApplicationListStats) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApplicationListStats.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ApplicationListStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationListStats.Merge(m, src)
}
func (m *ApplicationListStats) XXX_Size() int {
	return m.Size()
}
func (m *ApplicationListStats) XXX_DiscardUnknown() {
	xxx_messageInfo_ApplicationListStats.DiscardUnknown(m)
}

var xxx_messageInfo_ApplicationListStats proto.InternalMessageInfo

func (m *ApplicationListStats) GetTotal() int64 {
...
func (m *ApplicationListStats) GetTotalBySyncStatus() map[string]int64 {
	if m != nil {
		return m.TotalBySyncStatus
	}
	return nil
}

func (m *ApplicationListStats) GetTotalByHealthStatus() map[string]int64 {
	if m != nil {
		return m.TotalByHealthStatus
	}
	return nil
}

func (m *ApplicationListStats) GetAutoSyncEnabledCount() int64 {
	if m != nil && m.AutoSyncEnabledCount != nil {
		return *m.AutoSyncEnabledCount
	}
	return 0
}

func (m *ApplicationListStats) GetDestinations() []*v1alpha1.ApplicationDestination {
	if m != nil {
...
func (m *ApplicationListStats) GetNamespaces() []string {
	if m != nil {
		return m.Namespaces
	}
	return nil
...
func (m *ApplicationListStats) GetLabels() []*ApplicationLabelStats {
	if m != nil {
		return m.Labels
	}
	return nil
...
func (m *ApplicationLabelStats) Reset()         { *m = ApplicationLabelStats{} }
func (m *ApplicationLabelStats) String() string { return proto.CompactTextString(m) }
func (*ApplicationLabelStats) ProtoMessage()    {}
func (*ApplicationLabelStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{4}
}
func (m *ApplicationLabelStats) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApplicationLabelStats) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApplicationLabelStats.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ApplicationLabelStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationLabelStats.Merge(m, src)
}
func (m *ApplicationLabelStats) XXX_Size() int {
	return m.Size()
}
func (m *ApplicationLabelStats) XXX_DiscardUnknown() {
	xxx_messageInfo_ApplicationLabelStats.DiscardUnknown(m)
}

var xxx_messageInfo_ApplicationLabelStats proto.InternalMessageInfo

func (m *ApplicationLabelStats) GetKey() string {
	if m != nil && m.Key != nil {
		return *m.Key
	}
	return ""
...
func (m *ApplicationLabelStats) GetValues() []string {
	if m != nil {
		return m.Values
	}
	return nil
...
func init() {
	proto.RegisterEnum("application.ApplicationSortBy", ApplicationSortBy_name, ApplicationSortBy_value)
	proto.RegisterType((*ApplicationQuery)(nil), "application.ApplicationQuery")
	proto.RegisterType((*ApplicationListOptions)(nil), "application.ApplicationListOptions")
	proto.RegisterType((*ApplicationListResponse)(nil), "application.ApplicationListResponse")
	proto.RegisterType((*ApplicationListStats)(nil), "application.ApplicationListStats")
	proto.RegisterMapType((map[string]int64)(nil), "application.ApplicationListStats.TotalByHealthStatusEntry")
	proto.RegisterMapType((map[string]int64)(nil), "application.ApplicationListStats.TotalBySyncStatusEntry")
	proto.RegisterType((*ApplicationLabelStats)(nil), "application.ApplicationLabelStats")
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
type ApplicationServiceClient interface {
	...
	List(ctx context.Context, in *ApplicationQuery, opts ...grpc.CallOption) (*ApplicationListResponse, error)
...
func (c *applicationServiceClient) List(ctx context.Context, in *ApplicationQuery, opts ...grpc.CallOption) (*ApplicationListResponse, error) {
...
type ApplicationServiceServer interface {
	// List returns list of applications
	List(context.Context, *ApplicationQuery) (*ApplicationListResponse, error)
	// ListResourceEvents returns a list of event resources
...
func (*UnimplementedApplicationServiceServer) List(ctx context.Context, req *ApplicationQuery) (*ApplicationListResponse, error) {
...
func (m *ApplicationListOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationListOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationListOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.SortBy != nil {
		i = encodeVarintApplication(dAtA, i, uint64(*m.SortBy))
		i--
		dAtA[i] = 0x60
	}
	if m.Limit != nil {
...
func (m *ApplicationListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationListResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationListResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Stats == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("stats")
	} else {
		{
...
func (m *ApplicationListStats) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationListStats) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationListStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.AutoSyncEnabledCount == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("autoSyncEnabledCount")
	} else {
		i = encodeVarintApplication(dAtA, i, uint64(*m.AutoSyncEnabledCount))
		i--
		dAtA[i] = 0x20
	}
	if len(m.TotalByHealthStatus) > 0 {
		for k := range m.TotalByHealthStatus {
			v := m.TotalByHealthStatus[k]
			baseI := i
			i = encodeVarintApplication(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
			i -= len(k)
			copy(dAtA[i:], k)
	...
	if len(m.TotalBySyncStatus) > 0 {
		for k := range m.TotalBySyncStatus {
			v := m.TotalBySyncStatus[k]
			baseI := i
			i = encodeVarintApplication(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
	...
	if m.Total == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("total")
	} else {
...
func (m *ApplicationLabelStats) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationLabelStats) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationLabelStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Values) > 0 {
		for iNdEx := len(m.Values) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApplication(dAtA, i, uint64(len(m.Values[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *ApplicationListOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Offset != nil {
		n += 1 + sovApplication(uint64(*m.Offset))
	}
	if m.Limit != nil {
		n += 1 + sovApplication(uint64(*m.Limit))
	}
	if m.SortBy != nil {
		n += 1 + sovApplication(uint64(*m.SortBy))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ApplicationListResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationListStats) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.TotalBySyncStatus) > 0 {
		for k, v := range m.TotalBySyncStatus {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovApplication(uint64(len(k))) + 1 + sovApplication(uint64(v))
			n += mapEntrySize + 1 + sovApplication(uint64(mapEntrySize))
		}
	}
	if len(m.TotalByHealthStatus) > 0 {
		for k, v := range m.TotalByHealthStatus {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovApplication(uint64(len(k))) + 1 + sovApplication(uint64(v))
			n += mapEntrySize + 1 + sovApplication(uint64(mapEntrySize))
	...
	if m.AutoSyncEnabledCount != nil {
		n += 1 + sovApplication(uint64(*m.AutoSyncEnabledCount))
	}
	if len(m.Destinations) > 0 {
...
func (m *ApplicationLabelStats) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.Options == nil {
				m.Options = &ApplicationListOptions{}
			}
...
func (m *ApplicationListOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationListOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationListOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= ApplicationSortBy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ApplicationListResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Items = append(m.Items, &v1alpha1.Application{})
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("stats")
	}
...
func (m *ApplicationListStats) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationListStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationListStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalBySyncStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TotalBySyncStatus == nil {
				m.TotalBySyncStatus = make(map[string]int64)
			}
			var mapkey string
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.TotalBySyncStatus[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalByHealthStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TotalByHealthStatus == nil {
				m.TotalByHealthStatus = make(map[string]int64)
			}
			var mapkey string
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.TotalByHealthStatus[mapkey] = mapvalue
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoSyncEnabledCount", wireType)
			}
			var v int64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			...
			m.Destinations = append(m.Destinations, &v1alpha1.ApplicationDestination{})
		...
		case 7:
			...
			m.Labels = append(m.Labels, &ApplicationLabelStats{})
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("autoSyncEnabledCount")
	}
...
func (m *ApplicationLabelStats) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationLabelStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationLabelStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
