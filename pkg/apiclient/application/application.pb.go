...
type ResourcesQuery struct {
	...
	AppNamespace    *string `protobuf:"bytes,7,opt,name=appNamespace" json:"appNamespace,omitempty"`
	Project         *string `protobuf:"bytes,8,opt,name=project" json:"project,omitempty"`
	// If the response returns resource hooks
	IncludeResourceHook  *bool    `protobuf:"varint,9,opt,name=includeResourceHook" json:"includeResourceHook,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ResourcesQuery) GetIncludeResourceHook() bool {
	if m != nil && m.IncludeResourceHook != nil {
		return *m.IncludeResourceHook
	}
	return false
}
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
func (m *ResourcesQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IncludeResourceHook != nil {
		i--
		if *m.IncludeResourceHook {
			dAtA[i] = 1
		} else {
			dAtA[i] = 0
		}
...
func (m *ResourcesQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeResourceHook", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
