...
// InstanceInfo provides information about which Argo CD instance manages an application.
type InstanceInfo struct {
	InstanceName         *string  `protobuf:"bytes,1,opt,name=instance_name,json=instanceName" json:"instance_name,omitempty"`
	InstanceNamespace    *string  `protobuf:"bytes,2,opt,name=instance_namespace,json=instanceNamespace" json:"instance_namespace,omitempty"`
	InstanceUrl          *string  `protobuf:"bytes,3,opt,name=instance_url,json=instanceUrl" json:"instance_url,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *InstanceInfo) GetInstanceNamespace() string {
	if m != nil && m.InstanceNamespace != nil {
		return *m.InstanceNamespace
	}
	return ""
}

func (m *InstanceInfo) GetInstanceUrl() string {
	if m != nil && m.InstanceUrl != nil {
...
func init() {
	...
	proto.RegisterType((*InstanceInfo)(nil), "application.InstanceInfo")
}
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
type ApplicationServiceClient interface {
	...
	// GetInstanceInfo returns the Argo CD instance info for an application
	GetInstanceInfo(ctx context.Context, in *ApplicationQuery, opts ...grpc.CallOption) (*InstanceInfo, error)
}
...
func (c *applicationServiceClient) GetInstanceInfo(ctx context.Context, in *ApplicationQuery, opts ...grpc.CallOption) (*InstanceInfo, error) {
	out := new(InstanceInfo)
	err := c.cc.Invoke(ctx, "/application.ApplicationService/GetInstanceInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	...
	// GetInstanceInfo returns the Argo CD instance info for an application
	GetInstanceInfo(context.Context, *ApplicationQuery) (*InstanceInfo, error)
}
...
func (*UnimplementedApplicationServiceServer) GetInstanceInfo(ctx context.Context, req *ApplicationQuery) (*InstanceInfo, error) {
...
func _ApplicationService_GetInstanceInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplicationQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).GetInstanceInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/application.ApplicationService/GetInstanceInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).GetInstanceInfo(ctx, req.(*ApplicationQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ApplicationService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ApplicationService_GetInstanceInfo_Handler,
		},
	},
...
func (m *InstanceInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.InstanceUrl != nil {
		i -= len(*m.InstanceUrl)
		copy(dAtA[i:], *m.InstanceUrl)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.InstanceUrl)))
		i--
		dAtA[i] = 0x1a
	}
	if m.InstanceNamespace != nil {
		i -= len(*m.InstanceNamespace)
		copy(dAtA[i:], *m.InstanceNamespace)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.InstanceNamespace)))
		i--
		dAtA[i] = 0x12
	}
	if m.InstanceName != nil {
		...
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.InstanceName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *InstanceInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstanceNamespace", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			s := string(dAtA[iNdEx:postIndex])
			m.InstanceNamespace = &s
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstanceUrl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
