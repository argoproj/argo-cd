...
// ApplicationRenameRequest is a request to rename an application without
// recreating its managed resources.
type ApplicationRenameRequest struct {
	Name                 *string  `protobuf:"bytes,1,req,name=name" json:"name,omitempty"`
...
func (m *ApplicationRenameRequest) Reset()         { *m = ApplicationRenameRequest{} }
func (m *ApplicationRenameRequest) String() string { return proto.CompactTextString(m) }
func (*ApplicationRenameRequest) ProtoMessage()    {}
func (*ApplicationRenameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{12}
}
func (m *ApplicationRenameRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApplicationRenameRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApplicationRenameRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ApplicationRenameRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationRenameRequest.Merge(m, src)
}
func (m *ApplicationRenameRequest) XXX_Size() int {
	return m.Size()
}
func (m *ApplicationRenameRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ApplicationRenameRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ApplicationRenameRequest proto.InternalMessageInfo

func (m *ApplicationRenameRequest) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *ApplicationRenameRequest) GetNewName() string {
...
func (m *ApplicationRenameRequest) GetAppNamespace() string {
	if m != nil && m.AppNamespace != nil {
		return *m.AppNamespace
	}
	return ""
...
func (m *ApplicationRenameRequest) GetProject() string {
	if m != nil && m.Project != nil {
		return *m.Project
	}
	return ""
...
// ApplicationRenameResponse is returned after a successful rename. It carries the
// renamed application together with information about the resource (if any) that
// manages it, so callers can guide the semi-automatic finalization without having
// to re-derive ownership client-side (which depends on the server's tracking method).
type ApplicationRenameResponse struct {
	// application is the renamed application.
	Application *v1alpha1.Application `protobuf:"bytes,1,opt,name=application" json:"application,omitempty"`
	// managingOwnerName is the name of the resource that manages the application
	// (an ApplicationSet or an app-of-apps parent), or empty if the app is unmanaged.
	ManagingOwnerName *string `protobuf:"bytes,2,opt,name=managingOwnerName" json:"managingOwnerName,omitempty"`
	// managingOwnerKind is a human-readable kind for managingOwnerName, e.g.
	// "ApplicationSet" or "app-of-apps parent". Empty if the app is unmanaged.
	ManagingOwnerKind    *string  `protobuf:"bytes,3,opt,name=managingOwnerKind" json:"managingOwnerKind,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ApplicationRenameResponse) Reset()         { *m = ApplicationRenameResponse{} }
func (m *ApplicationRenameResponse) String() string { return proto.CompactTextString(m) }
func (*ApplicationRenameResponse) ProtoMessage()    {}
func (*ApplicationRenameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{13}
}
func (m *ApplicationRenameResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApplicationRenameResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApplicationRenameResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ApplicationRenameResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationRenameResponse.Merge(m, src)
}
func (m *ApplicationRenameResponse) XXX_Size() int {
	return m.Size()
}
func (m *ApplicationRenameResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ApplicationRenameResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ApplicationRenameResponse proto.InternalMessageInfo

func (m *ApplicationRenameResponse) GetApplication() *v1alpha1.Application {
	if m != nil {
		return m.Application
	}
	return nil
...
func (m *ApplicationRenameResponse) GetManagingOwnerName() string {
	if m != nil && m.ManagingOwnerName != nil {
		return *m.ManagingOwnerName
	}
	return ""
}

func (m *ApplicationRenameResponse) GetManagingOwnerKind() string {
	if m != nil && m.ManagingOwnerKind != nil {
		return *m.ManagingOwnerKind
	}
	return ""
}
...
func init() {
	...
	proto.RegisterType((*ApplicationRenameRequest)(nil), "application.ApplicationRenameRequest")
	proto.RegisterType((*ApplicationRenameResponse)(nil), "application.ApplicationRenameResponse")
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
type ApplicationServiceClient interface {
	...
	// Rename renames an application without recreating its managed resources
	Rename(ctx context.Context, in *ApplicationRenameRequest, opts ...grpc.CallOption) (*ApplicationRenameResponse, error)
...
func (c *applicationServiceClient) Rename(ctx context.Context, in *ApplicationRenameRequest, opts ...grpc.CallOption) (*ApplicationRenameResponse, error) {
	out := new(ApplicationRenameResponse)
	err := c.cc.Invoke(ctx, "/application.ApplicationService/Rename", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	...
	// Rename renames an application without recreating its managed resources
	Rename(context.Context, *ApplicationRenameRequest) (*ApplicationRenameResponse, error)
	// Sync syncs an application to its target state
...
func (*UnimplementedApplicationServiceServer) Rename(ctx context.Context, req *ApplicationRenameRequest) (*ApplicationRenameResponse, error) {
...
func _ApplicationService_Rename_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplicationRenameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).Rename(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/application.ApplicationService/Rename",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).Rename(ctx, req.(*ApplicationRenameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ApplicationService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Rename",
			Handler:    _ApplicationService_Rename_Handler,
		},
		{
			MethodName: "Sync",
...
func (m *ApplicationRenameRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationRenameRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationRenameRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.NewName == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("newName")
	} else {
		i -= len(*m.NewName)
		copy(dAtA[i:], *m.NewName)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.NewName)))
		i--
		dAtA[i] = 0x12
	}
	if m.Name == nil {
...
func (m *ApplicationRenameResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationRenameResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationRenameResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ManagingOwnerKind != nil {
		i -= len(*m.ManagingOwnerKind)
		copy(dAtA[i:], *m.ManagingOwnerKind)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.ManagingOwnerKind)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ManagingOwnerName != nil {
		i -= len(*m.ManagingOwnerName)
		copy(dAtA[i:], *m.ManagingOwnerName)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.ManagingOwnerName)))
		i--
		dAtA[i] = 0x12
	}
	if m.Application != nil {
...
func (m *ApplicationRenameRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationRenameResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.ManagingOwnerName != nil {
		l = len(*m.ManagingOwnerName)
		n += 1 + l + sovApplication(uint64(l))
	}
	if m.ManagingOwnerKind != nil {
		l = len(*m.ManagingOwnerKind)
		n += 1 + l + sovApplication(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *ApplicationRenameRequest) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationRenameRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationRenameRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("newName")
	}
...
func (m *ApplicationRenameResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationRenameResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationRenameResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManagingOwnerName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			s := string(dAtA[iNdEx:postIndex])
			m.ManagingOwnerName = &s
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManagingOwnerKind", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
