...
func (m *ApplicationMaintenanceQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationMaintenanceQuery.Merge(m, src)
}
...
func (m *ApplicationMaintenanceResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationMaintenanceResponse.Merge(m, src)
}
...
func (*UnimplementedApplicationServiceServer) GetApplicationMaintenanceState(ctx context.Context, req *ApplicationMaintenanceQuery) (*ApplicationMaintenanceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetApplicationMaintenanceState not implemented")
}
...
func (m *ApplicationMaintenanceQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ApplicationMaintenanceResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Windows) > 0 {
		for iNdEx := len(m.Windows) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApplication(dAtA, i, uint64(len(m.Windows[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
