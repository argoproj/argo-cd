...
type ApplicationQuery struct {
	...
	// the names of application
	Names []string `protobuf:"bytes,9,rep,name=names" json:"names,omitempty"`
	// the repos filter
	Repos []string `protobuf:"bytes,10,rep,name=repos" json:"repos,omitempty"`
	// the clusters filter
	Clusters []string `protobuf:"bytes,11,rep,name=clusters" json:"clusters,omitempty"`
	// the namespaces filter
	Namespaces []string `protobuf:"bytes,12,rep,name=namespaces" json:"namespaces,omitempty"`
	// the labels filter
	Labels []string `protobuf:"bytes,13,rep,name=labels" json:"labels,omitempty"`
	// the auto sync filter
	AutoSyncs []string `protobuf:"bytes,14,rep,name=autoSyncs" json:"autoSyncs,omitempty"`
	...
	// offset
	Offset *int64 `protobuf:"varint,30,opt,name=offset" json:"offset,omitempty"`
	// limit
	Limit *int64 `protobuf:"varint,31,opt,name=limit" json:"limit,omitempty"`
	// sort
	SortBy *string `protobuf:"bytes,32,opt,name=sortBy" json:"sortBy,omitempty"`
	// Range filters for watch optimization (min and max are included in response)
	MinName              *string  `protobuf:"bytes,33,opt,name=minName" json:"minName,omitempty"`
	MaxName              *string  `protobuf:"bytes,34,opt,name=maxName" json:"maxName,omitempty"`
	MinCreatedAt         *string  `protobuf:"bytes,35,opt,name=minCreatedAt" json:"minCreatedAt,omitempty"`
	MaxCreatedAt         *string  `protobuf:"bytes,36,opt,name=maxCreatedAt" json:"maxCreatedAt,omitempty"`
	MinSynchronizedAt    *string  `protobuf:"bytes,37,opt,name=minSynchronizedAt" json:"minSynchronizedAt,omitempty"`
	MaxSynchronizedAt    *string  `protobuf:"bytes,38,opt,name=maxSynchronizedAt" json:"maxSynchronizedAt,omitempty"`
...
func (m *ApplicationQuery) GetLabels() []string {
	if m != nil {
		return m.Labels
	}
	return nil
...
func (m *ApplicationQuery) GetAutoSyncs() []string {
	if m != nil {
		return m.AutoSyncs
	}
	return nil
...
func (m *ApplicationQuery) GetSortBy() string {
...
func (m *ApplicationQuery) GetMinCreatedAt() string {
	if m != nil && m.MinCreatedAt != nil {
		return *m.MinCreatedAt
	}
	return ""
}

func (m *ApplicationQuery) GetMaxCreatedAt() string {
	if m != nil && m.MaxCreatedAt != nil {
		return *m.MaxCreatedAt
	}
	return ""
}

func (m *ApplicationQuery) GetMinSynchronizedAt() string {
	if m != nil && m.MinSynchronizedAt != nil {
		return *m.MinSynchronizedAt
	}
	return ""
}

func (m *ApplicationQuery) GetMaxSynchronizedAt() string {
	if m != nil && m.MaxSynchronizedAt != nil {
		return *m.MaxSynchronizedAt
	}
	return ""
}
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
func (m *ApplicationQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxSynchronizedAt != nil {
		i -= len(*m.MaxSynchronizedAt)
		copy(dAtA[i:], *m.MaxSynchronizedAt)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.MaxSynchronizedAt)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xb2
	}
	if m.MinSynchronizedAt != nil {
		i -= len(*m.MinSynchronizedAt)
		copy(dAtA[i:], *m.MinSynchronizedAt)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.MinSynchronizedAt)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xaa
	}
	if m.MaxCreatedAt != nil {
		i -= len(*m.MaxCreatedAt)
		copy(dAtA[i:], *m.MaxCreatedAt)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.MaxCreatedAt)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa2
	...
	if m.MinCreatedAt != nil {
		i -= len(*m.MinCreatedAt)
		copy(dAtA[i:], *m.MinCreatedAt)
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.MinCreatedAt)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x9a
	...
	if m.SortBy != nil {
		...
		i = encodeVarintApplication(dAtA, i, uint64(len(*m.SortBy)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x82
	...
	if len(m.AutoSyncs) > 0 {
		for iNdEx := len(m.AutoSyncs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AutoSyncs[iNdEx])
			copy(dAtA[i:], m.AutoSyncs[iNdEx])
			i = encodeVarintApplication(dAtA, i, uint64(len(m.AutoSyncs[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
	if len(m.Labels) > 0 {
		for iNdEx := len(m.Labels) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApplication(dAtA, i, uint64(len(m.Labels[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (m *ApplicationQuery) Size() (n int) {
	...
	if m.MinCreatedAt != nil {
		l = len(*m.MinCreatedAt)
		n += 2 + l + sovApplication(uint64(l))
	}
	if m.MaxCreatedAt != nil {
		l = len(*m.MaxCreatedAt)
		n += 2 + l + sovApplication(uint64(l))
	}
	if m.MinSynchronizedAt != nil {
		l = len(*m.MinSynchronizedAt)
		n += 2 + l + sovApplication(uint64(l))
	}
	if m.MaxSynchronizedAt != nil {
		l = len(*m.MaxSynchronizedAt)
		n += 2 + l + sovApplication(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *ApplicationQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoSyncs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoSyncs = append(m.AutoSyncs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
		...
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinCreatedAt", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 36:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxCreatedAt", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 37:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinSynchronizedAt", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			s := string(dAtA[iNdEx:postIndex])
			m.MinSynchronizedAt = &s
			iNdEx = postIndex
		case 38:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxSynchronizedAt", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
