...
type ObjectSource struct {
	...
	AppLabels            map[string]string `protobuf:"bytes,8,rep,name=appLabels" json:"appLabels" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	SyncStatus           string            `protobuf:"bytes,9,opt,name=syncStatus" json:"syncStatus"`
	SyncStartedAt        v1.Time           `protobuf:"bytes,10,opt,name=syncStartedAt" json:"syncStartedAt"`
	SyncFinishedAt       *v1.Time          `protobuf:"bytes,11,opt,name=syncFinishedAt" json:"syncFinishedAt,omitempty"`
	HealthStatus         *string           `protobuf:"bytes,12,opt,name=healthStatus" json:"healthStatus,omitempty"`
	HealthMessage        *string           `protobuf:"bytes,13,opt,name=healthMessage" json:"healthMessage,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
var fileDescriptor_3ad9267ec62b112f = []byte{
	...
	,
}
