...
const (
	...
	ApplicationSetService_Watch_FullMethodName              = "/applicationset.ApplicationSetService/Watch"
)
...
type ApplicationSetServiceClient interface {
	...
	Watch(ctx context.Context, in *ApplicationSetWatchQuery, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1alpha1.ApplicationSetWatchEvent], error)
}
...
func (c *applicationSetServiceClient) Watch(ctx context.Context, in *ApplicationSetWatchQuery, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1alpha1.ApplicationSetWatchEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ApplicationSetService_ServiceDesc.Streams[0], ApplicationSetService_Watch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ApplicationSetWatchQuery, v1alpha1.ApplicationSetWatchEvent]{ClientStream: stream}
...
func (UnimplementedApplicationSetServiceServer) ListResourceEvents(context.Context, *ApplicationSetGetQuery) (*events.EventList, error) {
...
func _ApplicationSetService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ApplicationSetServiceServer).Watch(m, &grpc.GenericServerStream[ApplicationSetWatchQuery, v1alpha1.ApplicationSetWatchEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ApplicationSetService_WatchServer = grpc.ServerStreamingServer[v1alpha1.ApplicationSetWatchEvent]
