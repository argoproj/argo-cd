...
func (*SettingsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_settings_70ede64ec6b17db6, []int{0}
}
...
type Settings struct {
	...
	KustomizeBuildOptions string                                `protobuf:"bytes,6,opt,name=kustomizeBuildOptions,proto3" json:"kustomizeBuildOptions,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                              `json:"-"`
	XXX_unrecognized      []byte                                `json:"-"`
	XXX_sizecache         int32                                 `json:"-"`
}
...
func (*Settings) Descriptor() ([]byte, []int) {
	return fileDescriptor_settings_70ede64ec6b17db6, []int{1}
}
...
func (m *Settings) GetKustomizeBuildOptions() string {
	if m != nil {
...
func (*DexConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_settings_70ede64ec6b17db6, []int{2}
}
...
func (*Connector) Descriptor() ([]byte, []int) {
	return fileDescriptor_settings_70ede64ec6b17db6, []int{3}
}
...
func (*OIDCConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_settings_70ede64ec6b17db6, []int{4}
}
...
func (m *Settings) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.KustomizeBuildOptions) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintSettings(dAtA, i, uint64(len(m.KustomizeBuildOptions)))
...
func init() {
	proto.RegisterFile("server/settings/settings.proto", fileDescriptor_settings_70ede64ec6b17db6)
}

var fileDescriptor_settings_70ede64ec6b17db6 = []byte{
	// 604 bytes of a gzipped FileDescriptorProto
	,
}
