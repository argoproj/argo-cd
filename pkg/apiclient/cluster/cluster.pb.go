...
// ClusterListQuery is a query for listing cluster resources, with additional list-only filters
...
func (m *ClusterListQuery) Reset()         { *m = ClusterListQuery{} }
func (m *ClusterListQuery) String() string { return proto.CompactTextString(m) }
func (*ClusterListQuery) ProtoMessage()    {}
func (*ClusterListQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_a6b5ba0b5aa57b32, []int{2}
}
func (m *ClusterListQuery) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClusterListQuery) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClusterListQuery.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ClusterListQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterListQuery.Merge(m, src)
}
func (m *ClusterListQuery) XXX_Size() int {
	return m.Size()
}
func (m *ClusterListQuery) XXX_DiscardUnknown() {
	xxx_messageInfo_ClusterListQuery.DiscardUnknown(m)
}

var xxx_messageInfo_ClusterListQuery proto.InternalMessageInfo

func (m *ClusterListQuery) GetServer() string {
	if m != nil {
		return m.Server
	}
	return ""
...
func (m *ClusterListQuery) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ClusterListQuery) GetId() *ClusterID {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *ClusterListQuery) GetSelector() string {
	if m != nil {
		return m.Selector
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ClusterListQuery)(nil), "cluster.ClusterListQuery")
...
var fileDescriptor_a6b5ba0b5aa57b32 = []byte{
	...
	,
}
...
type ClusterServiceClient interface {
	...
	List(ctx context.Context, in *ClusterListQuery, opts ...grpc.CallOption) (*v1alpha1.ClusterList, error)
...
func (c *clusterServiceClient) List(ctx context.Context, in *ClusterListQuery, opts ...grpc.CallOption) (*v1alpha1.ClusterList, error) {
...
type ClusterServiceServer interface {
	// List returns list of clusters
	List(context.Context, *ClusterListQuery) (*v1alpha1.ClusterList, error)
	// Create creates a cluster
...
func (*UnimplementedClusterServiceServer) List(ctx context.Context, req *ClusterListQuery) (*v1alpha1.ClusterList, error) {
...
func _ClusterService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).List(ctx, req.(*ClusterListQuery))
	}
...
func (m *ClusterListQuery) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ClusterListQuery) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ClusterListQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ClusterListQuery) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterListQuery) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterListQuery: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterListQuery: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
