...
import (
	applicationv1beta1 "github.com/argoproj/argo-cd/v3/pkg/apis/application/v1beta1"
...
type ApplicationLister interface {
	...
	List(selector labels.Selector) (ret []*applicationv1beta1.Application, err error)
...
type applicationLister struct {
	listers.ResourceIndexer[*applicationv1beta1.Application]
}

// NewApplicationLister returns a new ApplicationLister.
func NewApplicationLister(indexer cache.Indexer) ApplicationLister {
	return &applicationLister{listers.New[*applicationv1beta1.Application](indexer, applicationv1beta1.Resource("application"))}
}

// Applications returns an object that can list and get Applications.
func (s *applicationLister) Applications(namespace string) ApplicationNamespaceLister {
	return applicationNamespaceLister{listers.NewNamespaced[*applicationv1beta1.Application](s.ResourceIndexer, namespace)}
}
...
type ApplicationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*applicationv1beta1.Application, error)
