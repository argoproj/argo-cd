...
func (c *ArgoprojV1alpha1Client) ArgoCDConfigurations(namespace string) ArgoCDConfigurationInterface {
	return newArgoCDConfigurations(c, namespace)
}
