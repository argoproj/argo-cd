...
type ApplicationInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*applicationv1beta1.ApplicationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *applicationv1beta1.Application, err error)
	ApplicationExpansion
}

// applications implements ApplicationInterface
type applications struct {
	*gentype.ClientWithList[*applicationv1beta1.Application, *applicationv1beta1.ApplicationList]
}

// newApplications returns a Applications
func newApplications(c *ArgoprojV1beta1Client, namespace string) *applications {
	return &applications{
		gentype.NewClientWithList[*applicationv1beta1.Application, *applicationv1beta1.ApplicationList](
			"applications",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *applicationv1beta1.Application { return &applicationv1beta1.Application{} },
			func() *applicationv1beta1.ApplicationList { return &applicationv1beta1.ApplicationList{} },
		),
	}
}
