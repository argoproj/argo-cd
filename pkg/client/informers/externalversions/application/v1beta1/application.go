...
import (
	...
	apisapplicationv1beta1 "github.com/argoproj/argo-cd/v3/pkg/apis/application/v1beta1"
	...
	applicationv1beta1 "github.com/argoproj/argo-cd/v3/pkg/client/listers/application/v1beta1"
...
type ApplicationInformer interface {
	...
	Lister() applicationv1beta1.ApplicationLister
}
...
type ApplicationIndexInformer cache.TypedSharedIndexInformer[*apisapplicationv1beta1.Application]

// ApplicationHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Application.
type ApplicationHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisapplicationv1beta1.Application]

// ApplicationDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Application.
type ApplicationDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisapplicationv1beta1.Application]

// ApplicationFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Application.
type ApplicationFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisapplicationv1beta1.Application]

// ApplicationIndexers is a specialization of [cache.TypedIndexers] for Application.
type ApplicationIndexers = cache.TypedIndexers[*apisapplicationv1beta1.Application]

// DeletedApplication is a specialization of [cache.DeletedObject] for Application.
type DeletedApplication = cache.DeletedObject[*apisapplicationv1beta1.Application]
...
func NewTypedApplicationInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) ApplicationIndexInformer {
	gvr := schema.GroupVersionResource{Group: "argoproj.io", Version: "v1beta1", Resource: "applications"}
	identifier := options.InformerName.WithResource(gvr)
	tweakListOptions := options.TweakListOptions
	return cache.NewTypedSharedIndexInformer[*apisapplicationv1beta1.Application](cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ArgoprojV1beta1().Applications(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ArgoprojV1beta1().Applications(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ArgoprojV1beta1().Applications(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.ArgoprojV1beta1().Applications(namespace).Watch(ctx, opts)
			},
		}, client),
		&apisapplicationv1beta1.Application{},
...
func (f *applicationInformer) TypedInformer() ApplicationIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisapplicationv1beta1.Application](f.factory.InformerFor(&apisapplicationv1beta1.Application{}, f.defaultInformer))
}

func (f *applicationInformer) Lister() applicationv1beta1.ApplicationLister {
	return applicationv1beta1.NewApplicationLister(f.Informer().GetIndexer())
}
...
func (a *applicationTypedInformerAdapter) TypedInformer() ApplicationIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisapplicationv1beta1.Application](a.Informer())
}
...
func ToApplicationIndexInformer(informer cache.SharedIndexInformer) ApplicationIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisapplicationv1beta1.Application](informer)
}
