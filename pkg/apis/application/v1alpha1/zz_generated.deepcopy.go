...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterQuery) DeepCopyInto(out *ClusterQuery) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterQuery.
func (in *ClusterQuery) DeepCopy() *ClusterQuery {
	if in == nil {
		return nil
	}
	out := new(ClusterQuery)
	in.DeepCopyInto(out)
	return out
}
