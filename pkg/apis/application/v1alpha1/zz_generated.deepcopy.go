...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSyncWindow) DeepCopyInto(out *ApplicationSyncWindow) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSyncWindow.
func (in *ApplicationSyncWindow) DeepCopy() *ApplicationSyncWindow {
	if in == nil {
		return nil
	}
	out := new(ApplicationSyncWindow)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ApplicationSyncWindows) DeepCopyInto(out *ApplicationSyncWindows) {
	{
		in := &in
		*out = make(ApplicationSyncWindows, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ApplicationSyncWindow)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSyncWindows.
func (in ApplicationSyncWindows) DeepCopy() ApplicationSyncWindows {
	if in == nil {
		return nil
	}
	out := new(ApplicationSyncWindows)
	in.DeepCopyInto(out)
	return *out
}
