...
func (in *AppProjectSpec) DeepCopyInto(out *AppProjectSpec) {
	*out = *in
	...
	if in.UnmanagedResources != nil {
		in, out := &in.UnmanagedResources, &out.UnmanagedResources
		*out = new(UnmanagedResourcesMonitorSettings)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ApplicationTree) DeepCopyInto(out *ApplicationTree) {
	*out = *in
	...
	if in.UnmanagedNodes != nil {
		in, out := &in.UnmanagedNodes, &out.UnmanagedNodes
		*out = make([]ResourceNode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnmanagedResourceKey) DeepCopyInto(out *UnmanagedResourceKey) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnmanagedResourceKey.
func (in *UnmanagedResourceKey) DeepCopy() *UnmanagedResourceKey {
	if in == nil {
		return nil
	}
	out := new(UnmanagedResourceKey)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnmanagedResourcesMonitorSettings) DeepCopyInto(out *UnmanagedResourcesMonitorSettings) {
	*out = *in
	if in.Warn != nil {
	...
	if in.Ignore != nil {
		...
		*out = make([]UnmanagedResourceKey, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnmanagedResourcesMonitorSettings.
func (in *UnmanagedResourcesMonitorSettings) DeepCopy() *UnmanagedResourcesMonitorSettings {
	if in == nil {
		return nil
	}
	out := new(UnmanagedResourcesMonitorSettings)
