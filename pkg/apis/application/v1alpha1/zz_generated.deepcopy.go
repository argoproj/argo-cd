...
func (in *PullRequestGenerator) DeepCopyInto(out *PullRequestGenerator) {
	*out = *in
	...
	if in.ScmManager != nil {
		in, out := &in.ScmManager, &out.ScmManager
		*out = new(PullRequestGeneratorScmManager)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PullRequestGeneratorScmManager) DeepCopyInto(out *PullRequestGeneratorScmManager) {
	*out = *in
	if in.TokenRef != nil {
		in, out := &in.TokenRef, &out.TokenRef
		*out = new(SecretRef)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PullRequestGeneratorScmManager.
func (in *PullRequestGeneratorScmManager) DeepCopy() *PullRequestGeneratorScmManager {
	if in == nil {
		return nil
	}
	out := new(PullRequestGeneratorScmManager)
...
func (in *SCMProviderGenerator) DeepCopyInto(out *SCMProviderGenerator) {
	*out = *in
	...
	if in.ScmManager != nil {
		in, out := &in.ScmManager, &out.ScmManager
		*out = new(SCMProviderGeneratorScmManager)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SCMProviderGeneratorScmManager) DeepCopyInto(out *SCMProviderGeneratorScmManager) {
	*out = *in
	if in.TokenRef != nil {
		in, out := &in.TokenRef, &out.TokenRef
		*out = new(SecretRef)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SCMProviderGeneratorScmManager.
