...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RelatedRevisionMetadata) DeepCopyInto(out *RelatedRevisionMetadata) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RelatedRevisionMetadata.
func (in *RelatedRevisionMetadata) DeepCopy() *RelatedRevisionMetadata {
	if in == nil {
		return nil
	}
	out := new(RelatedRevisionMetadata)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RevisionMetadata) DeepCopyInto(out *RevisionMetadata) {
	*out = *in
	...
	if in.RelatedRevisions != nil {
		in, out := &in.RelatedRevisions, &out.RelatedRevisions
		*out = make([]RelatedRevisionMetadata, len(*in))
		copy(*out, *in)
	}
	return
}
