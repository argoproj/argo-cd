...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSetRolloutGroup) DeepCopyInto(out *ApplicationSetRolloutGroup) {
	*out = *in
	if in.Steps != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSetRolloutGroup.
func (in *ApplicationSetRolloutGroup) DeepCopy() *ApplicationSetRolloutGroup {
	if in == nil {
		return nil
	}
	out := new(ApplicationSetRolloutGroup)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ApplicationSetRolloutStrategy) DeepCopyInto(out *ApplicationSetRolloutStrategy) {
	*out = *in
	...
	if in.ParallelGroups != nil {
		in, out := &in.ParallelGroups, &out.ParallelGroups
		*out = make([]ApplicationSetRolloutGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
