...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StringOrObject) DeepCopyInto(out *StringOrObject) {
	*out = *in
	if in.Raw != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StringOrObject.
func (in *StringOrObject) DeepCopy() *StringOrObject {
	if in == nil {
		return nil
	}
	out := new(StringOrObject)
	in.DeepCopyInto(out)
	return out
}
