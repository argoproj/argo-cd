...
func (in *PullRequestGenerator) DeepCopyInto(out *PullRequestGenerator) {
	*out = *in
	...
	if in.SourceCraft != nil {
		in, out := &in.SourceCraft, &out.SourceCraft
		*out = new(PullRequestGeneratorSourceCraft)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PullRequestGeneratorSourceCraft) DeepCopyInto(out *PullRequestGeneratorSourceCraft) {
	*out = *in
	if in.TokenRef != nil {
		in, out := &in.TokenRef, &out.TokenRef
		*out = new(SecretRef)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PullRequestGeneratorSourceCraft.
func (in *PullRequestGeneratorSourceCraft) DeepCopy() *PullRequestGeneratorSourceCraft {
	if in == nil {
		return nil
	}
	out := new(PullRequestGeneratorSourceCraft)
...
func (in *SCMProviderGenerator) DeepCopyInto(out *SCMProviderGenerator) {
	*out = *in
	...
	if in.SourceCraft != nil {
		in, out := &in.SourceCraft, &out.SourceCraft
		*out = new(SCMProviderGeneratorSourceCraft)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SCMProviderGeneratorSourceCraft) DeepCopyInto(out *SCMProviderGeneratorSourceCraft) {
	*out = *in
	if in.TokenRef != nil {
		in, out := &in.TokenRef, &out.TokenRef
		*out = new(SecretRef)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SCMProviderGeneratorSourceCraft.
func (in *SCMProviderGeneratorSourceCraft) DeepCopy() *SCMProviderGeneratorSourceCraft {
	if in == nil {
		return nil
	}
	out := new(SCMProviderGeneratorSourceCraft)
