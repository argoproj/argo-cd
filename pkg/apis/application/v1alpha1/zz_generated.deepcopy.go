...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppOfAppsRules) DeepCopyInto(out *AppOfAppsRules) {
	*out = *in
	if in.SameProjectOnly != nil {
		in, out := &in.SameProjectOnly, &out.SameProjectOnly
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppOfAppsRules.
func (in *AppOfAppsRules) DeepCopy() *AppOfAppsRules {
	if in == nil {
		return nil
	}
	out := new(AppOfAppsRules)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AppProjectSpec) DeepCopyInto(out *AppProjectSpec) {
	*out = *in
	...
	if in.AppOfAppsRules != nil {
		in, out := &in.AppOfAppsRules, &out.AppOfAppsRules
		*out = new(AppOfAppsRules)
		(*in).DeepCopyInto(*out)
	}
	return
