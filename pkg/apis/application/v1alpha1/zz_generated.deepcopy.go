...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CreateNamespaceMetadata) DeepCopyInto(out *CreateNamespaceMetadata) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreateNamespaceMetadata.
func (in *CreateNamespaceMetadata) DeepCopy() *CreateNamespaceMetadata {
	if in == nil {
		return nil
	}
	out := new(CreateNamespaceMetadata)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SyncPolicy) DeepCopyInto(out *SyncPolicy) {
	*out = *in
	...
	in.CreateNamespaceMetadata.DeepCopyInto(&out.CreateNamespaceMetadata)
	return
}
