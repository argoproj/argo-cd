...
func (in *ApplicationSetGenerator) DeepCopyInto(out *ApplicationSetGenerator) {
	*out = *in
	...
	if in.DeploymentStrategy != nil {
		...
		*out = new(GeneratorDeploymentStrategy)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorDeploymentPhase) DeepCopyInto(out *GeneratorDeploymentPhase) {
	*out = *in
	if in.Targets != nil {
		in, out := &in.Targets, &out.Targets
		*out = make([]GeneratorPhaseTarget, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Checks != nil {
		...
		*out = make([]GeneratorPhaseCheck, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PreHooks != nil {
		...
		*out = make([]GeneratorPhaseHook, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.OnFailure != nil {
		...
		*out = new(GeneratorPhaseFailureAction)
		**out = **in
	}
	if in.MaxUpdate != nil {
		in, out := &in.MaxUpdate, &out.MaxUpdate
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorDeploymentPhase.
func (in *GeneratorDeploymentPhase) DeepCopy() *GeneratorDeploymentPhase {
	if in == nil {
		return nil
	}
	out := new(GeneratorDeploymentPhase)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorDeploymentStrategy) DeepCopyInto(out *GeneratorDeploymentStrategy) {
	*out = *in
	if in.Phases != nil {
		in, out := &in.Phases, &out.Phases
		*out = make([]GeneratorDeploymentPhase, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorDeploymentStrategy.
func (in *GeneratorDeploymentStrategy) DeepCopy() *GeneratorDeploymentStrategy {
	if in == nil {
		return nil
	}
	out := new(GeneratorDeploymentStrategy)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseCheck) DeepCopyInto(out *GeneratorPhaseCheck) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = new(GeneratorPhaseCheckCommand)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = new(GeneratorPhaseCheckHTTP)
		(*in).DeepCopyInto(*out)
	}
	if in.Timeout != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseCheck.
func (in *GeneratorPhaseCheck) DeepCopy() *GeneratorPhaseCheck {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseCheck)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseCheckCommand) DeepCopyInto(out *GeneratorPhaseCheckCommand) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseCheckCommand.
func (in *GeneratorPhaseCheckCommand) DeepCopy() *GeneratorPhaseCheckCommand {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseCheckCommand)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseCheckHTTP) DeepCopyInto(out *GeneratorPhaseCheckHTTP) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseCheckHTTP.
func (in *GeneratorPhaseCheckHTTP) DeepCopy() *GeneratorPhaseCheckHTTP {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseCheckHTTP)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseFailureAction) DeepCopyInto(out *GeneratorPhaseFailureAction) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseFailureAction.
func (in *GeneratorPhaseFailureAction) DeepCopy() *GeneratorPhaseFailureAction {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseFailureAction)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseHook) DeepCopyInto(out *GeneratorPhaseHook) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = new(GeneratorPhaseCheckCommand)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseHook.
func (in *GeneratorPhaseHook) DeepCopy() *GeneratorPhaseHook {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseHook)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeneratorPhaseTarget) DeepCopyInto(out *GeneratorPhaseTarget) {
	*out = *in
	if in.MatchExpressions != nil {
		in, out := &in.MatchExpressions, &out.MatchExpressions
		*out = make([]ApplicationMatchExpression, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeneratorPhaseTarget.
func (in *GeneratorPhaseTarget) DeepCopy() *GeneratorPhaseTarget {
	if in == nil {
		return nil
	}
	out := new(GeneratorPhaseTarget)
	in.DeepCopyInto(out)
	return out
}
