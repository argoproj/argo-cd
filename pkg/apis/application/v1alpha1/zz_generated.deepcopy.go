...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppprojStatus) DeepCopyInto(out *AppprojStatus) {
	*out = *in
	if in.JWTTokenMap != nil {
		in, out := &in.JWTTokenMap, &out.JWTTokenMap
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppprojStatus.
func (in *AppprojStatus) DeepCopy() *AppprojStatus {
	if in == nil {
		return nil
	}
	out := new(AppprojStatus)
	in.DeepCopyInto(out)
	return out
}
