...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectMaintenance) DeepCopyInto(out *ProjectMaintenance) {
	*out = *in
	if in.Windows != nil {
		in, out := &in.Windows, &out.Windows
		*out = make(ProjectMaintenanceWindows, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ProjectMaintenanceWindow)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectMaintenance.
func (in *ProjectMaintenance) DeepCopy() *ProjectMaintenance {
	if in == nil {
		return nil
	}
	out := new(ProjectMaintenance)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectMaintenanceWindow) DeepCopyInto(out *ProjectMaintenanceWindow) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectMaintenanceWindow.
func (in *ProjectMaintenanceWindow) DeepCopy() *ProjectMaintenanceWindow {
	if in == nil {
		return nil
	}
	out := new(ProjectMaintenanceWindow)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ProjectMaintenanceWindows) DeepCopyInto(out *ProjectMaintenanceWindows) {
	{
		in := &in
		*out = make(ProjectMaintenanceWindows, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectMaintenanceWindows.
func (in ProjectMaintenanceWindows) DeepCopy() ProjectMaintenanceWindows {
	if in == nil {
		return nil
	}
	out := new(ProjectMaintenanceWindows)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RevisionHistoryStatus) DeepCopyInto(out *RevisionHistoryStatus) {
	*out = *in
	out.Health = in.Health
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RevisionHistoryStatus.
func (in *RevisionHistoryStatus) DeepCopy() *RevisionHistoryStatus {
	if in == nil {
		return nil
	}
	out := new(RevisionHistoryStatus)
	in.DeepCopyInto(out)
	return out
}
