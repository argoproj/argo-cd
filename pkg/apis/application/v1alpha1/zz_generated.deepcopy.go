...
func (in *SyncOperation) DeepCopyInto(out *SyncOperation) {
	*out = *in
	...
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = make([]SyncWaitOperationResource, len(*in))
		copy(*out, *in)
	}
	if in.Source != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncWaitOperationResource) DeepCopyInto(out *SyncWaitOperationResource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncWaitOperationResource.
func (in *SyncWaitOperationResource) DeepCopy() *SyncWaitOperationResource {
	if in == nil {
		return nil
	}
	out := new(SyncWaitOperationResource)
	in.DeepCopyInto(out)
	return out
}
