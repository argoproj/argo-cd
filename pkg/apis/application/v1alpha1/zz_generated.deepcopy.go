...
func (in *GitGenerator) DeepCopyInto(out *GitGenerator) {
	*out = *in
	if in.Directories != nil {
		...
		*out = make([]GitGeneratorItem, len(*in))
		copy(*out, *in)
	}
	if in.Files != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitGeneratorItem) DeepCopyInto(out *GitGeneratorItem) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitGeneratorItem.
func (in *GitGeneratorItem) DeepCopy() *GitGeneratorItem {
	if in == nil {
		return nil
	}
	out := new(GitGeneratorItem)
	in.DeepCopyInto(out)
	return out
}
