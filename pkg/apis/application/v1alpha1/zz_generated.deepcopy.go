...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WindowRule) DeepCopyInto(out *WindowRule) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WindowRule.
func (in *WindowRule) DeepCopy() *WindowRule {
	if in == nil {
		return nil
	}
	out := new(WindowRule)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in WindowRules) DeepCopyInto(out *WindowRules) {
	{
		in := &in
		*out = make(WindowRules, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WindowRules.
func (in WindowRules) DeepCopy() WindowRules {
	if in == nil {
		return nil
	}
	out := new(WindowRules)
