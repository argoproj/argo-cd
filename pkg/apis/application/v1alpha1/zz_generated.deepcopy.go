...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectToken) DeepCopyInto(out *ProjectToken) {
	*out = *in
	if in.Policies != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectToken.
func (in *ProjectToken) DeepCopy() *ProjectToken {
	if in == nil {
		return nil
	}
	out := new(ProjectToken)
	in.DeepCopyInto(out)
	return out
}
