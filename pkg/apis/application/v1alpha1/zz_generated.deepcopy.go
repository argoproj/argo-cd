...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncPolicySelfHeal) DeepCopyInto(out *SyncPolicySelfHeal) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncPolicySelfHeal.
func (in *SyncPolicySelfHeal) DeepCopy() *SyncPolicySelfHeal {
	if in == nil {
		return nil
	}
	out := new(SyncPolicySelfHeal)
