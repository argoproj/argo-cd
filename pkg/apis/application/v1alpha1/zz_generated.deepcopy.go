...
func (in *ApplicationSourceKustomize) DeepCopyInto(out *ApplicationSourceKustomize) {
	*out = *in
	...
	out.ForceCommonLabels = in.ForceCommonLabels
	out.ForceCommonAnnotations = in.ForceCommonAnnotations
	out.CommonAnnotationsEnvsubst = in.CommonAnnotationsEnvsubst
	if in.Replicas != nil {
