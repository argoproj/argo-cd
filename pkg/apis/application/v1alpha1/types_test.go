...
func TestAppProject_IsGroupKindPermitted(t *testing.T) {
	proj := AppProject{
		Spec: AppProjectSpec{
			...
			NamespaceResourceBlacklist: []BlacklistEntry{{Group: "apps", Kind: "Deployment"}},
		},
	}
	...
	proj3 := AppProject{
		Spec: AppProjectSpec{
			ClusterResourceBlacklist: []BlacklistEntry{{Group: "", Kind: "Namespace"}},
		},
	}
	...
	proj4 := AppProject{
		Spec: AppProjectSpec{
			...
			ClusterResourceBlacklist: []BlacklistEntry{{Group: "*", Kind: "*"}},
		},
	}
