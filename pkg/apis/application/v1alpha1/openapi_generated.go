		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"ref": {
						SchemaProps: spec.SchemaProps{
							Description: "Ref specifies the ref of the source to copy from.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"sourcePath": {
						SchemaProps: spec.SchemaProps{
							Description: "SourcePath is the path from the Ref'd repository, the source of the copy operation.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"ref", "sourcePath", "destinationPath"},
			},
		},
	}
}
