		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"restrictedBy": {
						SchemaProps: spec.SchemaProps{
							Description: "RestrictedBy, if set, causes the listed Projects' restrictions to be applied to this Project",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"projectsMustBeRestrictedBy": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectsMustBeRestrictedBy is a list of patterns determining which parentProjects are allowed to be set on Projects managed by Applications under this Project. If the list is empty, any value is allowed for parentProject.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
