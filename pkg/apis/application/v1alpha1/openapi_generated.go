		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"paramPrefix": {
						SchemaProps: spec.SchemaProps{
							Description: "ParamPrefix is a prefix to add to all parameters generated by this generator.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"paramPrefix": {
						SchemaProps: spec.SchemaProps{
							Description: "ParamPrefix is a prefix that will be added to all parameters returned by the plugin.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"paramPrefix": {
						SchemaProps: spec.SchemaProps{
							Description: "ParamPrefix is the prefix for parameters to be passed to the template.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
