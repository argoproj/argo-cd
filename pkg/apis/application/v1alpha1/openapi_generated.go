		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description contains a free-text summary of the application, shown alongside its name in the UI",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"configHash": {
						SchemaProps: spec.SchemaProps{
							Description: "ConfigHash is an opaque value which tracks changes to the desired configuration of a Cluster",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"Name", "Path", "BuildOptions"},
			},
		},
	}
}
