...
const (
	...
	// AnnotationKeyHydrateTimestamp is set to a unique timestamp identifying a specific hydration request. Removed by application controller after
	// app is hydrated.
	AnnotationKeyHydrateTimestamp string = "argocd.argoproj.io/hydrate-timestamp"
