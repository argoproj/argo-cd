...
type ApplicationSetStatus struct {
	...
	// OrphanedCount is the number of Applications that are owned by this application set but no longer
	// generated by it. Unlike the Orphaned markers on the items in the Resources field, this count is
	// not affected by the resource status list being truncated.
	OrphanedCount int64 `json:"orphanedCount,omitempty" protobuf:"varint,6,opt,name=orphanedCount"`
}
