...
type ApplicationSetStatus struct {
	...
	// AbandonedCount is the number of Applications that are still owned by this application set but
	// no longer generated by it. Unlike the Abandoned markers on the items in the Resources field,
	// this count is not affected by the resource status list being truncated.
	AbandonedCount int64 `json:"abandonedCount,omitempty" protobuf:"varint,6,opt,name=abandonedCount"`
}
