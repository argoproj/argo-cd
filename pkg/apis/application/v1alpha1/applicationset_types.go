...
type ClusterGenerator struct {
	...
	// ParamPrefix is a prefix to add to all parameters generated by this generator.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,4,name=paramPrefix"`
}
...
type DuckTypeGenerator struct {
	...
	// ParamPrefix is a prefix to add to all parameters generated by this generator.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,7,name=paramPrefix"`
}
...
type GitGenerator struct {
	...
	// ParamPrefix is a prefix to add to all parameters generated by this generator.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,9,name=paramPrefix"`
}
...
type SCMProviderGenerator struct {
	...
	// ParamPrefix is a prefix to add to all parameters generated by this generator.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,13,name=paramPrefix"`
}
...
type PullRequestGenerator struct {
	...
	// ParamPrefix is the prefix for parameters to be passed to the template.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,10,opt,name=paramPrefix"`
}
...
type PluginGenerator struct {
	...
	// ParamPrefix is a prefix that will be added to all parameters returned by the plugin.
	ParamPrefix string `json:"paramPrefix,omitempty" protobuf:"bytes,6,name=paramPrefix"`
}
