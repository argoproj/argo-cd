...
// GeneratorDeploymentStrategy configures how applications generated by a specific generator are deployed
type GeneratorDeploymentStrategy struct {
	Type   string                     `json:"type,omitempty" protobuf:"bytes,1,opt,name=type"`
	Phases []GeneratorDeploymentPhase `json:"phases,omitempty" protobuf:"bytes,2,opt,name=phases"`
}

// GeneratorDeploymentPhase represents a single deployment phase
type GeneratorDeploymentPhase struct {
	Name         string                       `json:"name" protobuf:"bytes,1,opt,name=name"`
	Targets      []GeneratorPhaseTarget       `json:"targets" protobuf:"bytes,2,rep,name=targets"`
	Checks       []GeneratorPhaseCheck        `json:"checks,omitempty" protobuf:"bytes,3,rep,name=checks"`
	PreHooks     []GeneratorPhaseHook         `json:"preHooks,omitempty" protobuf:"bytes,8,rep,name=preHooks"`
	PostHooks    []GeneratorPhaseHook         `json:"postHooks,omitempty" protobuf:"bytes,9,rep,name=postHooks"`
...
type GeneratorPhaseTarget struct {
	MatchExpressions []ApplicationMatchExpression `json:"matchExpressions,omitempty" protobuf:"bytes,1,rep,name=matchExpressions"`
	Clusters         []string                     `json:"clusters,omitempty" protobuf:"bytes,2,rep,name=clusters"`
	Values           map[string]string            `json:"values,omitempty" protobuf:"bytes,3,rep,name=values"`
}

// GeneratorPhaseCheck defines a check to run before proceeding to the next phase
type GeneratorPhaseCheck struct {
	Name    string                      `json:"name" protobuf:"bytes,1,opt,name=name"`
	Type    string                      `json:"type" protobuf:"bytes,2,opt,name=type"`
	Command *GeneratorPhaseCheckCommand `json:"command,omitempty" protobuf:"bytes,3,opt,name=command"`
	HTTP    *GeneratorPhaseCheckHTTP    `json:"http,omitempty" protobuf:"bytes,4,opt,name=http"`
	Timeout *metav1.Duration            `json:"timeout,omitempty" protobuf:"bytes,5,opt,name=timeout"`
}

// GeneratorPhaseCheckCommand defines a command-based check
type GeneratorPhaseCheckCommand struct {
	Command []string          `json:"command" protobuf:"bytes,1,rep,name=command"`
	Env     map[string]string `json:"env,omitempty" protobuf:"bytes,2,rep,name=env"`
}

// GeneratorPhaseCheckHTTP defines an HTTP-based check
type GeneratorPhaseCheckHTTP struct {
...
// GeneratorPhaseHook defines a hook to run before or after a phase deployment
type GeneratorPhaseHook struct {
	Name          string                      `json:"name" protobuf:"bytes,1,opt,name=name"`
	Type          string                      `json:"type" protobuf:"bytes,2,opt,name=type"`
	Command       *GeneratorPhaseCheckCommand `json:"command,omitempty" protobuf:"bytes,3,opt,name=command"`
	HTTP          *GeneratorPhaseCheckHTTP    `json:"http,omitempty" protobuf:"bytes,4,opt,name=http"`
	Timeout       *metav1.Duration            `json:"timeout,omitempty" protobuf:"bytes,5,opt,name=timeout"`
	FailurePolicy string                      `json:"failurePolicy,omitempty" protobuf:"bytes,6,opt,name=failurePolicy"`
}

// GeneratorPhaseFailureAction defines what to do when a phase fails
type GeneratorPhaseFailureAction struct {
...
type ApplicationSetGenerator struct {
	...
	// DeploymentStrategy configures how applications generated by this generator are deployed across clusters
	DeploymentStrategy *GeneratorDeploymentStrategy `json:"deploymentStrategy,omitempty" protobuf:"bytes,11,opt,name=deploymentStrategy"`
}
...
type ApplicationSetTerminalGenerator struct {
	...
	// DeploymentStrategy configures how applications generated by this generator are deployed across clusters
	DeploymentStrategy *GeneratorDeploymentStrategy `json:"deploymentStrategy,omitempty" protobuf:"bytes,9,opt,name=deploymentStrategy"`
}
...
func (g ApplicationSetTerminalGenerators) toApplicationSetNestedGenerators() []ApplicationSetNestedGenerator {
	...
	for i, terminalGenerator := range g {
		nestedGenerators[i] = ApplicationSetNestedGenerator{
			...
			DeploymentStrategy:      terminalGenerator.DeploymentStrategy,
		}
	}
