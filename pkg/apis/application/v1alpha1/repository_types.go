...
func (m *Repository) HasCredentials() bool {
	return m.Username != "" || m.Password != "" || m.SSHPrivateKey != "" || m.TLSClientCertData != "" || m.GithubAppPrivateKey != "" || m.UseAzureWorkloadIdentity
}
...
func (m *Repository) Sanitized() *Repository {
	return &Repository{
		...
		UseAzureWorkloadIdentity:   m.UseAzureWorkloadIdentity,
	}
}
