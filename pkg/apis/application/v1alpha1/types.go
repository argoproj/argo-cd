...
type ApplicationSpec struct {
	...
	// SyncWindowRefs references external SyncWindow objects that apply directly to this application.
...
type AppProjectSpec struct {
	...
	// SyncWindowRefs references external SyncWindow objects that define sync windows for this project.
