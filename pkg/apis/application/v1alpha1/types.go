...
type ApplicationSourceHelm struct {
	...
	// SkipTests skips test manifest installation step (Helm's --skip-tests). By default, Argo CD assumes it is set to true.
...
func (h *ApplicationSourceHelm) IsZero() bool {
	return h == nil || (h.Version == "") && (h.ReleaseName == "") && len(h.ValueFiles) == 0 && len(h.Parameters) == 0 && len(h.FileParameters) == 0 && h.ValuesIsEmpty() && !h.PassCredentials && !h.IgnoreMissingValueFiles && !h.SkipCrds && (h.SkipTests == nil || *h.SkipTests) && h.KubeVersion == "" && len(h.APIVersions) == 0 && h.Namespace == ""
}
