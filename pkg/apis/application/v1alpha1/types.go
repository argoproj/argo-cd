...
// ApplicationLabelStats holds label key and its values
...
type ApplicationListStats struct {
	...
	TotalBySyncStatus   map[SyncStatusCode]int64          `json:"totalBySyncStatus,omitempty" protobuf:"bytes,2,rep,name=totalBySyncStatus"`
	TotalByHealthStatus map[health.HealthStatusCode]int64 `json:"totalByHealthStatus,omitempty" protobuf:"bytes,3,rep,name=totalByHealthStatus"`
	AutoSyncCount       map[string]int64                  `json:"autoSyncCount" protobuf:"bytes,4,opt,name=autoSyncCount"`
	Destinations        []ApplicationDestination          `json:"destinations" protobuf:"bytes,5,rep,name=destinations"`
	Namespaces          []string                          `json:"namespaces" protobuf:"bytes,6,rep,name=namespaces"`
	Labels              []ApplicationLabelStats           `json:"labels,omitempty" protobuf:"bytes,7,rep,name=labels"`
}
