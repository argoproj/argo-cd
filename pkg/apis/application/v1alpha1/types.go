...
func (s *SyncPolicyAutomated) MaintenanceWindowActive() (bool, error) {
...
func (s *SyncPolicyAutomated) ListMaintenanceWindows() string {
	if s.MaintenanceWindows == nil {
		return "<none>"
	}
	var windows string
	noWindows := len(s.MaintenanceWindows)
