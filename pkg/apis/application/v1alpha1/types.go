...
type SyncOperation struct {
	...
	// Overrides sync source with a local directory for development
	LocalManifests []string `json:"localManifests,omitempty" protobuf:"bytes,8,rep,name=localManifests"`
}
