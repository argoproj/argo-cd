...
type ResourceStatus struct {
	...
	// Abandoned is true for an Application that is still owned by an ApplicationSet but no longer
	// generated by it, for example after a generator change under a non-deleting applicationsSync
	// policy. It is only set on the entries of an ApplicationSet's resource status, never on an
	// Application's.
	Abandoned bool `json:"abandoned,omitempty" protobuf:"bytes,12,opt,name=abandoned"`
}
