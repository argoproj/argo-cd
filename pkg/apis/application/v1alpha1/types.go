...
type RevisionHistory struct {
	...
	RevisionSignature string `json:"revisionSignature,omitempty" protobuf:"bytes,11,opt,name=revisionSignature"`
	// RevisionSignatures is a signature of the Revisions field
	RevisionSignatures []string `json:"revisionSignatures,omitempty" protobuf:"bytes,12,opt,name=revisionSignatures"`
}
