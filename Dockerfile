...
####################################################################################################
FROM docker.io/library/golang:1.25.1@sha256:9b057a4fa31e7fbe0e5927b6cb167f929b49033d14dd2f3203f45be8479b30f2 AS builder
...
RUN groupadd -g $ARGOCD_USER_ID argocd && \
    ...
    apt-get install -y \
    git curl tini gpg tzdata connect-proxy && \
    apt-get clean && \
    rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
...
####################################################################################################
FROM --platform=$BUILDPLATFORM docker.io/library/golang:1.25.1@sha256:9b057a4fa31e7fbe0e5927b6cb167f929b49033d14dd2f3203f45be8479b30f2 AS argocd-build
