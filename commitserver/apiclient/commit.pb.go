...
type CommitHydratedManifestsResponse struct {
	// HydratedRevision is the revision of the hydrated manifests commit.
	HydratedRevision     string   `protobuf:"bytes,1,opt,name=hydrated_revision,json=hydratedRevision,proto3" json:"hydrated_revision,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CommitHydratedManifestsResponse) GetHydratedRevision() string {
	if m != nil {
		return m.HydratedRevision
	}
	return ""
}
...
var fileDescriptor_cf3a3abbc35e3069 = []byte{
	...
	,
}
...
func (m *CommitHydratedManifestsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HydratedRevision) > 0 {
		i -= len(m.HydratedRevision)
		copy(dAtA[i:], m.HydratedRevision)
		i = encodeVarintCommit(dAtA, i, uint64(len(m.HydratedRevision)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CommitHydratedManifestsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HydratedRevision", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HydratedRevision = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCommit(dAtA[iNdEx:])
