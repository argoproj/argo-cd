...
func NewCommand() *cobra.Command {
	...
	command.Flags().StringSliceVar(&metricsAplicationLabels, "metrics-application-labels", []string{}, "List of Application labels that will be added to the argocd_app_labels metric")
	command.Flags().StringSliceVar(&metricsAplicationRevisions, "metrics-application-revisions", env.StringsFromEnv("ARGOCD_METRICS_APP_REVISIONS", []string{"head", "main", "master", "develop"}, ","), "List of Application revisions that will be added to the argocd_app_info metric")
