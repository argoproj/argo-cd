...
func NewCommand() *cobra.Command {
	...
	command.Flags().Int64Var(&kubectlParallelismLimit, "kubectl-parallelism-limit", int64(env.ParseNumFromEnv("ARGOCD_APPLICATION_CONTROLLER_KUBECTL_PARALLELISM_LIMIT", 20, 0, math.MaxInt64)), "Number of allowed concurrent kubectl fork/execs. Any value less than 1 means no limit.")
