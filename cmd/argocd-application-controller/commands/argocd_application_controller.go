...
func NewCommand() *cobra.Command {
	...
	command.Flags().Float64Var(&appResyncJitter, "app-resync-jitter", env.ParseFloat64FromEnv("ARGOCD_RECONCILIATION_JITTER", 0, 0, math.MaxFloat64), "Maximum factor of time of the resync period to add as a delay jitter for application resync.")
