...
func NewCommand() *cobra.Command {
	...
	command.Flags().Int64Var(&repoErrorGracePeriod, "repo-error-grace", int64(env.ParseDurationFromEnv("ARGOCD_REPO_ERROR_GRACE_PERIOD", defaultAppResyncPeriod*time.Second, 0, math.MaxInt64).Seconds()), "Grace period in seconds for ignoring consecutive errors while communicating with repo server.")
