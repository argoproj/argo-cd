...
func NewCommand() *cobra.Command {
	...
	command.Flags().BoolVar(&enableProgressiveSyncs, "enable-progressive-rollouts", env.ParseBoolFromEnv("ARGOCD_APPLICATIONSET_CONTROLLER_ENABLE_PROGRESSIVE_SYNCS", false), "Enable use of the experimental progressive syncs feature.")
	return &command
}
