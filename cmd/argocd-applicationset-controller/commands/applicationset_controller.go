...
func NewCommand() *cobra.Command {
	...
	command.Flags().IntVar(&githubCacheSize, "github-cache-size", env.ParseNumFromEnv("ARGOCD_APPLICATIONSET_CONTROLLER_GITHUB_CACHE_SIZE", 2000, 1, math.MaxInt), "Maximum number of entries in the in-memory GitHub response cache per credential context")
