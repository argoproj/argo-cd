...
func NewCommand() *cobra.Command {
    ...
    rootCmd.Flags().StringVar(&inclusterServiceAccount, "in-cluster-service-account", env.StringFromEnv("ARGOCD_IN_CLUSTER_SERVICE_ACCOUNT", ""), "In-Cluster Kubernetes Service Account")
