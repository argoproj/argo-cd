...
import (
	...
	appcontroller "github.com/argoproj/argo-cd/cmd/argocd/argocd-application-controller/commands"
	dex "github.com/argoproj/argo-cd/cmd/argocd/argocd-dex/commands"
	reposerver "github.com/argoproj/argo-cd/cmd/argocd/argocd-repo-server/commands"
	apiserver "github.com/argoproj/argo-cd/cmd/argocd/argocd-server/commands"
	util "github.com/argoproj/argo-cd/tools/argocd-util/commands"
	cli "github.com/argoproj/argo-cd/tools/argocd/commands"
)
