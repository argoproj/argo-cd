...
func NewCommand() *cobra.Command {
	...
	command.PersistentFlags().StringVar(&clientOpts.RedisURL, "redis-url", env.StringFromEnv(common.EnvRedisURL, ""), fmt.Sprintf("Redis connection string; set this or the %s environment variable when using external Redis, for example when using AWS ElastiCache", common.EnvRedisURL))
