...
func NewCommand() *cobra.Command {
	...
	command.PersistentFlags().BoolVar(&clientOpts.K8SAPI, "k8s-api", false, "If set to true then CLI talks directly to Kubernetes instead of talking to Argo CD API server")
	return command
}
