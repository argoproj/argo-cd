...
`
	...
	command.Flags().StringVar(&repo.AzureCloud, "azure-cloud", "", "specify the azure cloud for azure workload identity authentication. Options are AzurePublic, AzureChina, AzureGovernment.")
