...
func TestDetailedPrintTreeViewAppResources(t *testing.T) {
	...
	printDetailedTreeViewAppResourcesNotOrphaned(nodeMapping, mapParentToChild, parentNode, false, false, tbl)
	output := tbl.String()
