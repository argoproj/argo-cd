...
func NewCommand() *cobra.Command {
	...
	command := cobra.Command{
		...
		RunE: func(c *cobra.Command, _ []string) error {
			...
			if enableClusterProfiles {
				...
				log.Info("ClusterProfile controller is disabled")
			}
	...
	command.Flags().BoolVar(&enableClusterProfiles, "enable-cluster-profiles", env.ParseBoolFromEnv("ARGOCD_CLUSTERPROFILE_CONTROLLER_ENABLE_CLUSTER_PROFILES", false), "Enable the ClusterProfile controller functionality.")
