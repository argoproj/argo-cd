...
func NewCommand() *cobra.Command {
	...
	command.Flags().BoolVar(&managedByArgo, "managed-by-argo", env.ParseBoolFromEnv("ARGOCD_REPO_SERVER_MANAGED_BY_ARGO", false), "Set managed-by label for every k8s resource generated by argo Current Status: Alpha (Since v2.8.0)")
