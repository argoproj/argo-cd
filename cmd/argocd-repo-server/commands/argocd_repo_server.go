...
func NewCommand() *cobra.Command {
	...
	command.Flags().BoolVar(&mergeRepositoryCAWithSystem, "merge-repository-ca-with-system", mergeRepositoryCAWithSystem, "Merge repository-specific TLS CAs with the system trust store for Helm, Kustomize, and native HTTP clients (default true).")
