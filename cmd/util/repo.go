...
func AddRepoFlags(command *cobra.Command, opts *RepoOptions) {
	...
	command.Flags().StringVar(&opts.AzureCloud, "azure-cloud", "", "the Azure cloud to use when authenticating with azure workload identity (e.g. AzurePublic, AzureChina, AzureGovernment. Defaults to AzurePublic)")
