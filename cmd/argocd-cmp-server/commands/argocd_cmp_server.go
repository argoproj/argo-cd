...
func NewCommand() *cobra.Command {
	...
	command.Flags().StringVar(&configFilePath, "config-file-path", common.DefaultPluginConfigFilePath, "Config management plugin configuration file location, Default is '/home/argocd/cmp-server/config/'")
	return &command
}
