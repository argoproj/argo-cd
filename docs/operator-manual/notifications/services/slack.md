...
1. Once application is created, click `Enter OAuth & Permissions`.
![2](https://user-images.githubusercontent.com/426437/73604309-4d495b80-4543-11ea-9908-4dea403d3399.png)
1. Navigate to `Scopes` section and add `chat:write` scope to `Bot Token Scopes`. To use the optional username and icon overrides in the Slack notification service also add the `chat:write.customize` scope.
![3](/docs/assets/slack-add-scope.png)  
