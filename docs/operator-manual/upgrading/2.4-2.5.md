...
2.5 introduces a new `applicationsets` [RBAC resource](../../operator-manual/rbac.md#the-applicationsets-resource).
...
You can continue to use the plugins by [installing them as sidecars](../../user-guide/config-management-plugins.md)
