...
In v2.7, the `--server-side-generate` argument will become the default, and client-side generation will be removed and client-side generation will be supported as an alternative.
