...
2.4 introduces a new `exec` [RBAC resource](../../operator-manual/rbac.md#the-exec-resource).
...
The exec feature is [disabled by default](../../operator-manual/rbac.md#the-exec-resource), 
