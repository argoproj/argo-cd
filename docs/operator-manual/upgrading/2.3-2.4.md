...
## Support for private repo SSH keys using the SHA-1 signature scheme hash algorithm is removed

Argo CD 2.4 upgraded its base image from Ubuntu 20.04 to Ubuntu 22.04, which upgraded OpenSSH to 8.7. That version
