...
>
> In other words, the Argo CD tracking annotation on the resources of an Application after the upgrade to 3.0 will only
> appear on the resources upon either a new Git commit or an explicit sync of the Application.
