...
Argo CD 2.5 introduced [Go templating in ApplicationSets](../../operator-manual/applicationset/GoTemplate.md). Go templates have access to the Sprig function library.
...
[OIDC configuration documentation](../../operator-manual/user-management/index.md#existing-oidc-provider)
for an example.)
