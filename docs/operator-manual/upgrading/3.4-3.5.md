...
No action is required for users who do not use GnuPG signature verification.
...
- Declaring `.spec.signatureKeys` in `AppProject` id deprecated.

Configure Source Integrity defined in `AppProject` manifest instead.
