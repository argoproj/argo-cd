...
| [`argocd-cluster-ca-cm.yaml`](argocd-cluster-ca-cm-yaml.md)         | argocd-cluster-ca-cm                                                               | ConfigMap | Default CA bundle for connecting to the Kubernetes API server of clusters (v3.7 and later) |
