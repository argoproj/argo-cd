...
```
      ...
      --enable-plugin-manifests-generation-using-manifest-generate-paths-annotation   Pass the resources described in argocd.argoproj.io/manifest-generate-paths value to the cmpserver to generate the application manifests.
