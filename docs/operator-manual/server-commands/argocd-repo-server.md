...
```
  ...
  -h, --help                                           help for argocd-repo-server
      ...
      --streamed-manifest-max-extracted-size int       Maximum size of streamed manifest archives when extracted (default 104857600)
      --streamed-manifest-max-tar-size int             Maximum size of streamed manifest archives (default 10485760)
