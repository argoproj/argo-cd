...
```
  ...
  -h, --help                                           help for argocd-repo-server
      ...
      --oci-layer-media-types string                   Semicolon separated list of allowed media types for OCI media types. This only accounts for media types within layers. (default "application/vnd.oci.image.layer.v1.tar;application/vnd.oci.image.layer.v1.tar+gzip;application/vnd.cncf.helm.chart.content.v1.tar+gzip")
