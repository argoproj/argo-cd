...
e.g. [https://accounts.google.com/.well-known/openid-configuration](https://accounts.google.com/.well-known/openid-configuration)
...
> (e.g. [https://argocd.example.com/auth/callback](https://argocd.example.com/auth/callback)).
