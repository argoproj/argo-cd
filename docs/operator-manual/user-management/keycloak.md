...
- __refreshTokenThreshold__ is less than the client token lifetime, 5 minutes by default.  If not less than the token lifetime, a new token will be obtained for every request.
