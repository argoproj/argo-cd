...
| `argocd_kubectl_client_cert_rotation_age`     |   gauge   | Age of kubectl client certificate rotation.                                                                                                 |
| `argocd_kubectl_request_latency_seconds`      | histogram | Latency of kubectl requests.                                                                                                                |
| `argocd_kubectl_resolver_latency_seconds`     | histogram | Latency of kubectl resolver.                                                                                                                |
| `argocd_kubectl_request_size_bytes`           |  summary  | Size of kubectl requests.                                                                                                                   |
| `argocd_kubectl_response_size_bytes`          |  summary  | Size of kubectl responses.                                                                                                                  |
| `argocd_kubectl_rate_limiter_latency_seconds` | histogram | Latency of kubectl rate limiter.                                                                                                            |
| `argocd_kubectl_request_result`               |  counter  | Result of kubectl requests.                                                                                                                 |
| `argocd_kubectl_exec_plugin_calls`            |  counter  | Number of kubectl exec plugin calls.                                                                                                        |
| `argocd_kubectl_request_retry`                |  counter  | Number of kubectl request retries.                                                                                                          |
| `argocd_kubectl_transport_cache_entries`      |   gauge   | Number of kubectl transport cache entries.                                                                                                  |
| `argocd_kubectl_transport_create_calls`       |  counter  | Number of kubectl transport create calls.                                                                                                   |

### Labels

| Label Name         | Example Value                   | Possible Values                                                                                                                                         | Description                                                                                                                                                                                     |
|--------------------|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| call_status        | no_error                        | no_error, plugin_execution_error, plugin_not_found_error, client_internal_error                                                                         | Status of the kubectl exec plugin call.                                                                                                                                                         |
| code               | 200                             | For metrics representing HTTP responses, this will be an HTTP response code.<br>For metrics representing command invocation, this will be an exit code. | HTTP status code returned by the request or exit code of a command. kubectl metrics produced by client-go use `code` for HTTP responses, while metrics produced by Argo CD use `response_code`. |
| command            | apply                           | apply, auth, create, replace                                                                                                                            | kubectl command executed.                                                                                                                                                                       |
| dest_server        | https://example.com             | Any Kubernetes cluster schema + hostname                                                                                                                | Destination server for an Application.                                                                                                                                                          |
| failed             | false                           | true, false                                                                                                                                             | Indicates if the Redis request failed.                                                                                                                                                          |
| group              | apps                            | Any valid Kubernetes resource group name                                                                                                                | Group name of a Kubernetes resource being monitored.                                                                                                                                            |
| host               | example.com                     | Any Kubernetes cluster hostname                                                                                                                         | Hostname of the Kubernetes API to which the request was made.                                                                                                                                   |
| hostname           | argocd-application-controller-0 | The hostname of some Argo CD component, usually the Pod's name                                                                                          | Hostname of the Argo CD component that initiated the request to Redis.                                                                                                                          |
| initiator          | argocd-server                   | argocd-application-controller, argocd-repo-server, argocd-server                                                                                        | Name of the Argo CD component that initiated the request to Redis.                                                                                                                              |
| kind               | Deployment                      | Any valid Kubernetes resource kind name.                                                                                                                | Kind name of a Kubernetes resource being monitored.                                                                                                                                             |
| method             | GET                             | GET, DELETE, PATCH, POST, PUT                                                                                                                           | HTTP method used for the request.                                                                                                                                                               |
| name               | my-app                          | Any valid Application name                                                                                                                              | Name of an Application.                                                                                                                                                                         |
| namespace          | default                         | Any valid Application namespace                                                                                                                         | Namespace of an Application (namespace where the Application CR is located, not the destination namespace).                                                                                     |
| phase              | Succeeded                       | Error, Failed, Running, Succeeded, Terminating                                                                                                          | Phase of a sync operation.                                                                                                                                                                      |
| project            | my-project                      | Any valid AppProject name                                                                                                                               | AppProject of an Application.                                                                                                                                                                   |
| resource_kind      | Pod                             | Any valid Kubernetes resource kind name                                                                                                                 | Kind of Kubernetes resource being synced.                                                                                                                                                       |
| resource_namespace | default                         | Any valid Kubernetes namespace name                                                                                                                     | Namespace of Kubernetes resource being synced.                                                                                                                                                  |
| response_code      | 404                             | Any HTTP response code                                                                                                                                  | HTTP response code from the server.                                                                                                                                                             |
| result             | hit                             | hit, miss, unreachable                                                                                                                                  | Result of an attempt to get a transport from the kubectl (client-go) transport cache.                                                                                                           |
| server             | https://example.com             | Any Kubernetes cluster schema + hostname                                                                                                                | Server where the operation is performed.                                                                                                                                                        |
| verb               | List                            | Get, Watch, List, Create, Delete, Patch, Update                                                                                                         | Kubernetes API verb used in the request.                                                                                                                                                        |
