...
- [numaplane.numaproj.io/ISBServiceRollout/disable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/ISBServiceRollout/actions/disable-full-promote/action.lua)
- [numaplane.numaproj.io/ISBServiceRollout/enable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/ISBServiceRollout/actions/enable-full-promote/action.lua)
- [numaplane.numaproj.io/MonoVertexRollout/disable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/MonoVertexRollout/actions/disable-full-promote/action.lua)
- [numaplane.numaproj.io/MonoVertexRollout/enable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/MonoVertexRollout/actions/enable-full-promote/action.lua)
...
- [numaplane.numaproj.io/PipelineRollout/disable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/PipelineRollout/actions/disable-full-promote/action.lua)
...
- [numaplane.numaproj.io/PipelineRollout/enable-full-promote](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/numaplane.numaproj.io/PipelineRollout/actions/enable-full-promote/action.lua)
