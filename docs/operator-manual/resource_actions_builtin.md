...
- [core.strimzi.io/StrimziPodSet/restart](https://github.com/argoproj/argo-cd/blob/master/resource_customizations/core.strimzi.io/StrimziPodSet/actions/restart/action.lua)
