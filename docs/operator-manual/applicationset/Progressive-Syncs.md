...
- [Argo CD Resource Hooks](../../user-guide/sync-waves.md#sync-phases-and-waves) are supported. We recommend this approach for users that need advanced functionality when an Argo Rollout cannot be used, such as smoke testing after a DaemonSet change.
