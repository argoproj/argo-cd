...
Argo CD permits declaring criteria for application sources that, when not met, will prevent an application from syncing with a `ResourceComparison` error.
...
They distinguish a type of verification they perform, and to which sources they apply to.
