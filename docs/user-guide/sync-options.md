...
This feature is based on Kubernetes' [client-side apply migration KEP](https://github.com/alexzielenski/enhancements), which provides the auto migration from client-side to server-side apply.
