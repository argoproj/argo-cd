...
```
      --azure-cloud string                      the Azure cloud to use when authenticating with azure workload identity (e.g. AzurePublic, AzureChina, AzureGovernment. Defaults to AzurePublic)
