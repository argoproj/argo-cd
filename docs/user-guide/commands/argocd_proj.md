...
* [argocd proj add-verification-rule](argocd_proj_add-verification-rule.md)	 - Adds a source verification rule for given project
...
* [argocd proj remove-verification-rule](argocd_proj_remove-verification-rule.md)	 - Removes a source verification rule from a given project
