...
* [argocd proj add-node-label](argocd_proj_add-node-label.md)	 - Add allowed node label
...
* [argocd proj remove-node-label](argocd_proj_remove-node-label.md)	 - Remove allowed node label
