...
```
  ...
  -n, --namespace string                     If present, the namespace scope for this CLI request
      ...
      --retry-on-conflict                    Retry on conflict when updating resources
      --server string                        The address and port of the Kubernetes API server
      --skip-resources-with-labels strings   Skip importing resources based on the labels e.g. '-- skip-resources-with-labels key=value'
