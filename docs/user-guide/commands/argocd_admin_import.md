...
```
  ...
  -n, --namespace string                     If present, the namespace scope for this CLI request
      ...
      --skip-resources-with-labels strings   Skip importing resources based on the labels e.g. '--skip-resources-with-labels my-label/example.io, my-other-label/example.io'
