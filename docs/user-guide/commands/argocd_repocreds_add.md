...
```
      ...
      --depth int                                      Specify a custom depth for git clone operations. A value of 0 performs a full clone. If unset, the depth is not inherited by repositories using this template.
