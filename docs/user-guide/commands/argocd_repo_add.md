...
```
  ...
  # Add a private Git repository on GitHub.com via GitHub App (github-app-installation-id is optional and will be auto-discovered if omitted)
  ...
  # Add a private Git repository on GitHub Enterprise via GitHub App (github-app-installation-id is optional and will be auto-discovered if omitted)
