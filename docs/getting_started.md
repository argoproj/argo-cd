...
If you are not interested in UI, SSO, multi-cluster features then you can install [core](operator-manual/installation.md#single-tenant-aka-core) Argo CD components only:
