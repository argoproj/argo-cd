...
type Clientset interface {
	NewConfigManagementPluginClient(ctx context.Context) (utilio.Closer, ConfigManagementPluginServiceClient, error)
}
...
func (c *clientSet) NewConfigManagementPluginClient(ctx context.Context) (utilio.Closer, ConfigManagementPluginServiceClient, error) {
