...
type CmpSettingsResponse struct {
	ProvideGitCreds      bool     `protobuf:"varint,1,opt,name=provideGitCreds,proto3" json:"provideGitCreds,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CmpSettingsResponse) Reset()         { *m = CmpSettingsResponse{} }
func (m *CmpSettingsResponse) String() string { return proto.CompactTextString(m) }
func (*CmpSettingsResponse) ProtoMessage()    {}
func (*CmpSettingsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b21875a7079a06ed, []int{7}
}
func (m *CmpSettingsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CmpSettingsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CmpSettingsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CmpSettingsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CmpSettingsResponse.Merge(m, src)
}
func (m *CmpSettingsResponse) XXX_Size() int {
	return m.Size()
}
func (m *CmpSettingsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CmpSettingsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CmpSettingsResponse proto.InternalMessageInfo

func (m *CmpSettingsResponse) GetProvideGitCreds() bool {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*CmpSettingsResponse)(nil), "plugin.CmpSettingsResponse")
}
...
var fileDescriptor_b21875a7079a06ed = []byte{
	...
	,
}
...
type ConfigManagementPluginServiceClient interface {
	...
	GetCmpSettings(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CmpSettingsResponse, error)
}
...
func (c *configManagementPluginServiceClient) GetCmpSettings(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CmpSettingsResponse, error) {
	out := new(CmpSettingsResponse)
	err := c.cc.Invoke(ctx, "/plugin.ConfigManagementPluginService/GetCmpSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigManagementPluginServiceServer interface {
	...
	// GetCmpSettings provides configuration information for the plugin
	GetCmpSettings(context.Context, *emptypb.Empty) (*CmpSettingsResponse, error)
}
...
func (*UnimplementedConfigManagementPluginServiceServer) GetCmpSettings(ctx context.Context, req *emptypb.Empty) (*CmpSettingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCmpSettings not implemented")
}
...
func _ConfigManagementPluginService_GetCmpSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigManagementPluginServiceServer).GetCmpSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/plugin.ConfigManagementPluginService/GetCmpSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigManagementPluginServiceServer).GetCmpSettings(ctx, req.(*emptypb.Empty))
	}
...
var _ConfigManagementPluginService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCmpSettings",
			Handler:    _ConfigManagementPluginService_GetCmpSettings_Handler,
		},
	},
...
func (m *CmpSettingsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CmpSettingsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CmpSettingsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CmpSettingsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CmpSettingsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CmpSettingsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CmpSettingsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
